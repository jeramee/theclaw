---
name: optimizetests
description: Optimize TheClaw slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real TheClaw test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `THECLAW_VITEST_IMPORT_DURATIONS=1 THECLAW_VITEST_PRINT_IMPORT_BREAKDOWN=1`
