---
name: theclaw-ghsa-maintainer
description: Inspect, patch, validate, publish, or confirm TheClaw GHSA security advisories and private-fork state.
---

# TheClaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `theclaw-release-maintainer`.
...
```bash
fork=$(gh api /repos/theclaw/theclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/theclaw/theclaw/security-advisories/<GHSA> \
