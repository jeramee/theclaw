---
name: theclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve TheClaw GitHub Secret Scanning alerts in issues or PRs.
---

# TheClaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/theclaw/theclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/theclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/theclaw/theclaw/issues/63101#issuecomment-xxx",
