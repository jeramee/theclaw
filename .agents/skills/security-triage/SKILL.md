...
description: Triage TheClaw security advisories, drafts, and GHSA reports with shipped-tag and trust-model proof.
---

# Security Triage

Use when reviewing TheClaw security advisories, drafts, or GHSA reports.
...
1. Read `SECURITY.md`.
2. Read the GHSA body with `gh api /repos/theclaw/theclaw/security-advisories/<GHSA>`.
...
```bash
gh api /repos/theclaw/theclaw/security-advisories/<GHSA>
gh api /repos/theclaw/theclaw/security-advisories --paginate
git tag --sort=-creatordate | head -n 20
npm view theclaw version --userconfig "$(mktemp)"
git tag --contains <commit>
git show <tag>:<path>
gh search issues --repo theclaw/theclaw --match title,body,comments -- "<terms>"
gh search prs --repo theclaw/theclaw --match title,body,comments -- "<terms>"
```
