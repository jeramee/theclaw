...
TheClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.theclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["theclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
