---
summary: "Testing utilities and patterns for TheClaw plugins"
...
Reference for test utilities, patterns, and lint enforcement for TheClaw
plugins.
...
**Plugin API mock import:** `theclaw/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `theclaw/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `theclaw/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `theclaw/plugin-sdk/channel-test-helpers`

**Channel target test import:** `theclaw/plugin-sdk/channel-target-testing`

**Plugin contract import:** `theclaw/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `theclaw/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `theclaw/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `theclaw/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `theclaw/plugin-sdk/test-env`

**Generic fixture import:** `theclaw/plugin-sdk/test-fixtures`

**Node builtin mock import:** `theclaw/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`theclaw/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "theclaw/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "theclaw/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "theclaw/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "theclaw/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "theclaw/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "theclaw/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "theclaw/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "theclaw/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "theclaw/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "theclaw/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "theclaw/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "theclaw/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "theclaw/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled TheClaw inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "theclaw/plugin-sdk/plugin-test-runtime";
```
...
TheClaw's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `theclaw/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `theclaw/plugin-sdk` root barrel is rejected
...
TheClaw uses Vitest with V8 coverage thresholds. For plugin tests:
