...
read_when:
  - You want Zalo Personal (unofficial) support in TheClaw
...
Zalo Personal support for TheClaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
