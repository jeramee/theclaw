...
read_when:
  - Planning a broad TheClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local TheClaw skill,
create `.agents/skills/theclaw-frontend/SKILL.md` first, keep the frontmatter
