...
title: "Together AI"
read_when:
  - You want to use Together AI with TheClaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    theclaw onboard --auth-choice together-api-key
    ```
  </Step>
...
TheClaw ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `theclaw models list --provider together`
