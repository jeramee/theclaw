...
<Steps>
  ...
  <Step title="Configure TheClaw">
    Point TheClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or TheClaw
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native TheClaw integration with Claude CLI or API keys.
  </Card>
