---
summary: "Use NVIDIA's OpenAI-compatible API in TheClaw"
read_when:
  - You want to use open models in TheClaw for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    theclaw onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    theclaw models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
