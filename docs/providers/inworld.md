---
summary: "Inworld streaming text-to-speech for TheClaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In TheClaw it
...
TheClaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. TheClaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    TheClaw asks Inworld for `OGG_OPUS` so the audio plays as a native
