---
summary: "Use ElevenLabs speech, Scribe STT, and realtime transcription with TheClaw"
read_when:
  - You want ElevenLabs text-to-speech in TheClaw
  - You want ElevenLabs Scribe speech-to-text for audio attachments
  - You want ElevenLabs realtime transcription for Voice Call
title: "ElevenLabs"
---

TheClaw uses ElevenLabs for text-to-speech, batch speech-to-text with Scribe
v2, and Voice Call streaming STT with Scribe v2 Realtime.

| Capability               | TheClaw surface                              | Default                  |
| ------------------------ | --------------------------------------------- | ------------------------ |
...
Set `modelId` to `eleven_v3` to use ElevenLabs v3 TTS. TheClaw keeps
...
TheClaw sends multipart audio to ElevenLabs `/v1/speech-to-text` with
