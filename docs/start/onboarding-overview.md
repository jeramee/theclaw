---
summary: "Overview of TheClaw onboarding options and flows"
read_when:
...
TheClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `theclaw onboard`                     | Launch the app            |
...
CLI command docs: [`theclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the TheClaw app. The first-run wizard walks you through the same steps
