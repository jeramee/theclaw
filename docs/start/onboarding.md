---
summary: "First-run setup flow for TheClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give TheClaw">
...
<Step title="CLI">
  ...
  The app can install the global `theclaw` CLI via npm, pnpm, or bun.
