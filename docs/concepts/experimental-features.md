---
summary: "What experimental flags mean in TheClaw and which ones are currently documented"
...
Experimental features in TheClaw are **opt-in preview surfaces**. They are
...
- If you are rolling TheClaw out broadly, test experimental flags in a smaller
...
| ------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Local model runtime      | `agents.defaults.experimental.localModelLean`             | A smaller or stricter local backend chokes on TheClaw's full default tool surface                             | [Local Models](/gateway/local-models)                                                         |
...
If a feature is experimental, TheClaw should say so plainly in docs and in the
