---
summary: "Use SOUL.md to give your TheClaw agent an actual voice instead of generic assistant sludge"
read_when:
...
TheClaw injects it on normal sessions, so it has real weight. If your agent
...
For TheClaw, `SOUL.md` is that layer.
...
Path fixed for TheClaw workspaces: use `SOUL.md`, not `http://SOUL.md`.
