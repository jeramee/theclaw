...
TheClaw also builds a separate idempotent replay view for sessions that
...
TheClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, TheClaw does not override them.
