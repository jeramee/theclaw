...
TheClaw treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

TheClaw "lives" on your own messaging accounts. There is no separate WhatsApp bot user. If **you** are in a group, TheClaw can see that group and respond there.
...
Translation: allowlisted senders can trigger TheClaw by mentioning it.
...
For group/channel rooms, TheClaw defaults to `messages.groupChat.visibleReplies: "message_tool"`.
...
By default, TheClaw prioritizes normal chat behavior and keeps context mostly as received. This means allowlists primarily decide who can trigger actions, not a universal redaction boundary for every quoted or historical snippet.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@theclaw", "theclaw", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
