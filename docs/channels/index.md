---
summary: "Messaging platforms TheClaw can connect to"
read_when:
  - You want to choose a chat channel for TheClaw
  - You need a quick overview of supported messaging platforms
title: "Chat channels"
---

TheClaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and TheClaw will route per chat.
