...
import ai.theclaw.app.VoiceCaptureMode
import ai.theclaw.app.voice.VoiceConversationEntry
import ai.theclaw.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("TheClaw is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
