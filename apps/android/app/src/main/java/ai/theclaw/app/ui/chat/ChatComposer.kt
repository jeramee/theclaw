...
import ai.theclaw.app.ui.mobileAccentBorderStrong
...
import ai.theclaw.app.ui.mobileHeadline
import ai.theclaw.app.ui.mobileSurface
import ai.theclaw.app.ui.mobileText
import ai.theclaw.app.ui.mobileTextSecondary
import ai.theclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.theclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.theclaw.app.ui.mobileFontFamily,
