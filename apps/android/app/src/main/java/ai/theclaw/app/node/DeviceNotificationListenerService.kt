...
import ai.theclaw.app.NotificationBurstLimiter
import ai.theclaw.app.SecurePrefs
import ai.theclaw.app.allowsPackage
import ai.theclaw.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("theclaw.secure", Context.MODE_PRIVATE)
