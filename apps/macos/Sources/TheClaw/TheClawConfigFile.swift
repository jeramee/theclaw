...
enum TheClawConfigFile {
    private static let logger = Logger(subsystem: "ai.theclaw", category: "config")
    ...
    static func url() -> URL {
        TheClawPaths.configURL
    }

    static func stateDirURL() -> URL {
        TheClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        TheClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-theclaw-config-file",
            "event": "config.write",
