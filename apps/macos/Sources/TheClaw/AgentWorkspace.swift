...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.theclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return TheClawConfigFile.defaultWorkspaceURL() }
