...
enum UIStrings {
    static let welcomeTitle = "Welcome to TheClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "theclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: TheClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g theclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: TheClawChatViewModel(
