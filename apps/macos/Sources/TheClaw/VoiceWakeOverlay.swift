...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.theclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other TheClaw windows, but below the system’s pop-up menus.
