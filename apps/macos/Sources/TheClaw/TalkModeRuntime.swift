...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.theclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.theclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [TheClawChatMessage] = messages.compactMap { item in
