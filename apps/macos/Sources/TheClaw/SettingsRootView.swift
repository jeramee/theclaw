...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .theclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? TheClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? TheClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let theclawSelectSettingsTab = Notification.Name("theclawSelectSettingsTab")
}
