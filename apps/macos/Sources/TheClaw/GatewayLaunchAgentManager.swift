...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.theclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".theclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.theclawCommand(
            subcommand: "gateway",
