...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/theclaw/theclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/theclaw/theclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://theclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "TheClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TheClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "TheClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TheClawGitCommit") as? String) ??
            "unknown"
    }
