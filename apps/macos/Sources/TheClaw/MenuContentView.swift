...
/// Menu contents for the TheClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About TheClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "TheClaw Not Configured"
        case .remote:
            "Remote TheClaw Active"
        case .local:
            "TheClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .theclawSelectSettingsTab, object: tab)
        }
    }
