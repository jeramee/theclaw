...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.theclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<TheClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = TheClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<TheClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: TheClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> TheClawActivityAttributes.ContentState {
        TheClawActivityAttributes.ContentState(
    ...
    private func idleState() -> TheClawActivityAttributes.ContentState {
        TheClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> TheClawActivityAttributes.ContentState {
        TheClawActivityAttributes.ContentState(
