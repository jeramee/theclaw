...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: TheClawPhotosLatestParams) async throws -> TheClawPhotosLatestPayload {
        ...
        var results: [TheClawPhotoPayload] = []
        ...
        return TheClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> TheClawPhotoPayload
    {
