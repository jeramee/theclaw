...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [TheClawCapability.canvas.rawValue, TheClawCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(TheClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(TheClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = TheClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(TheClawCapability.location.rawValue) }

        caps.append(TheClawCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(TheClawCapability.watch.rawValue)
        }
        caps.append(TheClawCapability.photos.rawValue)
        caps.append(TheClawCapability.contacts.rawValue)
        caps.append(TheClawCapability.calendar.rawValue)
        caps.append(TheClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(TheClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            TheClawScreenCommand.record.rawValue,
            TheClawSystemCommand.notify.rawValue,
            TheClawChatCommand.push.rawValue,
        ...
        if caps.contains(TheClawCapability.camera.rawValue) {
        ...
        if caps.contains(TheClawCapability.location.rawValue) {
            commands.append(TheClawLocationCommand.get.rawValue)
        }
        if caps.contains(TheClawCapability.device.rawValue) {
            commands.append(TheClawDeviceCommand.status.rawValue)
            commands.append(TheClawDeviceCommand.info.rawValue)
        }
        if caps.contains(TheClawCapability.watch.rawValue) {
            commands.append(TheClawWatchCommand.status.rawValue)
            commands.append(TheClawWatchCommand.notify.rawValue)
        }
        if caps.contains(TheClawCapability.photos.rawValue) {
            commands.append(TheClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(TheClawCapability.contacts.rawValue) {
            commands.append(TheClawContactsCommand.search.rawValue)
            commands.append(TheClawContactsCommand.add.rawValue)
        }
        if caps.contains(TheClawCapability.calendar.rawValue) {
            commands.append(TheClawCalendarCommand.events.rawValue)
            commands.append(TheClawCalendarCommand.add.rawValue)
        }
        if caps.contains(TheClawCapability.reminders.rawValue) {
            commands.append(TheClawRemindersCommand.list.rawValue)
            commands.append(TheClawRemindersCommand.add.rawValue)
        }
        if caps.contains(TheClawCapability.motion.rawValue) {
            commands.append(TheClawMotionCommand.activity.rawValue)
            commands.append(TheClawMotionCommand.pedometer.rawValue)
        }
