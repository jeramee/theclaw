...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.theclaw.gateway"
    private static let nodeService = "ai.theclaw.node"
    private static let talkService = "ai.theclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.theclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.theclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("theclaw-gateway.log")
    }
