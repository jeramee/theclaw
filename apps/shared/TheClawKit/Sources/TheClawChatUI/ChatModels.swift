...
public typealias TheClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias TheClawPlatformImage = UIImage
#endif

public struct TheClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct TheClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: TheClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(TheClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct TheClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct TheClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [TheClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: TheClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [TheClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: TheClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(TheClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([TheClawChatMessageContent].self, forKey: .content) {
...
public struct TheClawChatHistoryPayload: Codable, Sendable {
...
public struct TheClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct TheClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [TheClawSessionPreviewItem]
}

public struct TheClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [TheClawSessionPreviewEntry]

    public init(ts: Int, previews: [TheClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct TheClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct TheClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct TheClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct TheClawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct TheClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct TheClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: TheClawPlatformImage?
...
public struct TheClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
