...
public struct TheClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct TheClawChatSessionsDefaults: Codable, Sendable {
...
public struct TheClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct TheClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: TheClawChatSessionsDefaults?
    public let sessions: [TheClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [TheClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
