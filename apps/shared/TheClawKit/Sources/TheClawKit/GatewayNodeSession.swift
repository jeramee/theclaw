...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.theclaw", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.theclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: TheClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
