...
public enum TheClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct TheClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct TheClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
