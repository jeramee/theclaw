...
public enum TheClawTalkCommand: String, Codable, Sendable {
...
public struct TheClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct TheClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
