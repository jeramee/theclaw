...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: TheClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": TheClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": TheClawProtocol.AnyCodable(publicKey),
            "signature": TheClawProtocol.AnyCodable(signature),
            "signedAt": TheClawProtocol.AnyCodable(signedAtMs),
            "nonce": TheClawProtocol.AnyCodable(nonce),
        ]
    }
}
