...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "theclaw devices approve req-123",
            docsURLString: "https://docs.theclaw.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "theclaw devices approve req-123")
        #expect(error.docsURLString == "https://docs.theclaw.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "theclaw devices approve req-123")
    }
