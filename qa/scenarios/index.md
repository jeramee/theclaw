...
- use `pnpm theclaw qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the TheClaw QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this TheClaw repo from source + docs before acting.
