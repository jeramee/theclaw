...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as THECLAW_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                THECLAW_HOME: homeDir,
                THECLAW_CONFIG_PATH: configPath,
                THECLAW_STATE_DIR: stateDir,
                THECLAW_OAUTH_DIR: path.join(stateDir, "credentials"),
                THECLAW_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
