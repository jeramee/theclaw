...
execution:
  ...
  config:
    firstPrompt: "@theclaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@theclaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
