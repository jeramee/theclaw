...
import { createSubsystemLogger, redactSensitiveText } from "./theclaw-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./theclaw-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "theclaw:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip TheClaw-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/theclaw/theclaw/issues/63921
 */
