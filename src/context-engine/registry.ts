...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("theclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("theclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: TheClawConfig): Promise<ContextEngine> {
