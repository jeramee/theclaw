/**
 * Standalone MCP server that exposes TheClaw plugin-registered tools
...
function resolveTools(config: TheClawConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  return createToolsMcpServer({ name: "theclaw-plugin-tools", tools });
}
