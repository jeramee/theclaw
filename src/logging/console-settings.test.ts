...
let originalTheClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalTheClawTestConsole = process.env.THECLAW_TEST_CONSOLE;
  process.env.THECLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalTheClawTestConsole === undefined) {
    delete process.env.THECLAW_TEST_CONSOLE;
  } else {
    process.env.THECLAW_TEST_CONSOLE = originalTheClawTestConsole;
  }
