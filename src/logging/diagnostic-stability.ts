...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __theclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__theclawDiagnosticStabilityState ??= createState();
  return globalStore.__theclawDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__theclawDiagnosticStabilityState = next;
}
