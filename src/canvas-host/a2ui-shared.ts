...
export const A2UI_PATH = "/__theclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__theclaw__/canvas";

export const CANVAS_WS_PATH = "/__theclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.theclawCanvasA2UIAction.postMessage(...)
  // - Android: window.theclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["theclawCanvasA2UIAction"];
  ...
  globalThis.TheClaw = globalThis.TheClaw ?? {};
  globalThis.TheClaw.postMessage = postToNode;
  globalThis.TheClaw.sendUserAction = sendUserAction;
  globalThis.theclawPostMessage = postToNode;
  globalThis.theclawSendUserAction = sendUserAction;
