  ...
  return withEnvAsync(
    {
      ...
      THECLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when THECLAW_VERSION is not set", async () => {
  ...
  it("prefers THECLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over THECLAW_SERVICE_VERSION when THECLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        THECLAW_VERSION: " ",
        THECLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when THECLAW_VERSION and THECLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        THECLAW_VERSION: " ",
        THECLAW_SERVICE_VERSION: "\t",
