...
const DEFAULT_HOST_PATH = "~/.theclaw/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `TheClaw default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `TheClaw default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
