...
import { openClawRootFs, openClawRootFsSync } from "./theclaw-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["theclaw"]);
...
export async function resolveTheClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveTheClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
