...
describe("npm registry spec validation", () => {
  it.each([
    "@theclaw/voice-call",
    "@theclaw/voice-call@1.2.3",
    "@theclaw/voice-call@1.2.3-beta.4",
    "@theclaw/voice-call@latest",
    "@theclaw/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/theclaw/theclaw",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@theclaw/voice-call@1.2.3-beta.1",
      expected: {
        name: "@theclaw/voice-call",
        raw: "@theclaw/voice-call@1.2.3-beta.1",
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@theclaw/voice-call@latest",
  ...
  it.each([
    {
      spec: "@theclaw/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@theclaw/voice-call@beta"`,
    },
    {
      spec: "@theclaw/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
