...
describe("startProxy", () => {
  ...
  it("uses THECLAW_PROXY_URL when config proxyUrl is omitted", async () => {
    process.env["THECLAW_PROXY_URL"] = "http://127.0.0.1:3128";
  ...
  it("prefers config proxyUrl over THECLAW_PROXY_URL", async () => {
    process.env["THECLAW_PROXY_URL"] = "http://127.0.0.1:3128";
  ...
  it("throws for HTTPS proxy URLs from THECLAW_PROXY_URL", async () => {
    process.env["THECLAW_PROXY_URL"] = "https://127.0.0.1:3128";
  ...
  it("sets both undici and global-agent proxy env vars", async () => {
    ...
    expect(process.env["THECLAW_PROXY_ACTIVE"]).toBe("1");
  });
  ...
  it("restores previous proxy env and global-agent state on stop", async () => {
    ...
    expect(process.env["THECLAW_PROXY_ACTIVE"]).toBeUndefined();
