...
function resolveRealtimeVoiceProviderEntries(cfg?: TheClawConfig): RealtimeVoiceProviderPlugin[] {
...
function buildProviderMaps(cfg?: TheClawConfig): {
...
export function listRealtimeVoiceProviders(cfg?: TheClawConfig): RealtimeVoiceProviderPlugin[] {
