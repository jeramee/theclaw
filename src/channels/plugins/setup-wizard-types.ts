...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: TheClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: TheClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: TheClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: TheClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: TheClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: TheClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: TheClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: TheClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: TheClawConfig) => TheClawConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: TheClawConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: TheClawConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: TheClawConfig, policy: DmPolicy, accountId?: string) => TheClawConfig;
