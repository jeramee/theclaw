...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: TheClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: TheClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: TheClawConfig): string {
