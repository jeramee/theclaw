...
export function listChannelMessageActions(cfg: TheClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: TheClawConfig): ChannelMessageCapability[] {
