...
import type {
  ...
  TheClawProviderIndexPluginInstall,
  TheClawProviderIndexPlugin,
  TheClawProviderIndexProviderAuthChoice,
  TheClawProviderIndexProvider,
} from "./types.js";

const THECLAW_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): TheClawProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): TheClawProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): TheClawProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): TheClawProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): TheClawProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly TheClawProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is TheClawProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): TheClawProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeTheClawProviderIndex(value: unknown): TheClawProviderIndex | undefined {
  if (!isRecord(value) || value.version !== THECLAW_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, TheClawProviderIndexProvider> = {};
  ...
  return {
    version: THECLAW_PROVIDER_INDEX_VERSION,
