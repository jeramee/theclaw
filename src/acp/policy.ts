...
export function isAcpEnabledByPolicy(cfg: TheClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: TheClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: TheClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: TheClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: TheClawConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: TheClawConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: TheClawConfig, agentId: string): boolean {
