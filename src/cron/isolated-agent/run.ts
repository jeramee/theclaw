...
function hasConfiguredAuthProfiles(cfg: TheClawConfig): boolean {
  return (
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: TheClawConfig = {
    ...input.cfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.THECLAW_TEST_FAST === "1";
