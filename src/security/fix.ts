...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TheClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TheClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: TheClawConfig;
  changes: string[];
} {
