...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.theclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("theclaw hooks list")}`,
      `  ${formatCliCommand("theclaw hooks enable <name>")}`,
      `  ${formatCliCommand("theclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
