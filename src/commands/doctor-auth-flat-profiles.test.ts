...
import {
  createTheClawTestState,
  type TheClawTestState,
} from "../test-utils/theclaw-test-state.js";
import { maybeRepairLegacyFlatAuthProfileStores } from "./doctor-auth-flat-profiles.js";
import type { DoctorPrompter } from "./doctor-prompter.js";

const states: TheClawTestState[] = [];
...
async function makeTestState(): Promise<TheClawTestState> {
  const state = await createTheClawTestState({
    layout: "state-only",
    prefix: "theclaw-doctor-flat-auth-",
    env: {
