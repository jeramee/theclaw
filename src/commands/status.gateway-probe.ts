...
export async function resolveGatewayProbeAuthResolution(cfg: TheClawConfig): Promise<{
  auth: {
    token?: string;
    password?: string;
  };
...
export async function resolveGatewayProbeAuth(cfg: TheClawConfig): Promise<{
  token?: string;
  password?: string;
}> {
