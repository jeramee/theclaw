...
export function collectMissingDefaultAccountBindingWarnings(cfg: TheClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: TheClawConfig): string[] {
  const warnings: string[] = [];
