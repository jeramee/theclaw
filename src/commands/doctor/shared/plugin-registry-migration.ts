...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "THECLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "THECLAW_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<TheClawConfig> | TheClawConfig;
  };
...
function listConfiguredChannelIds(config: TheClawConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: TheClawConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as TheClawConfig;
