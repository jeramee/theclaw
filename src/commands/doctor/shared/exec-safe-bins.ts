...
function collectExecSafeBinScopes(cfg: TheClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: TheClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: TheClawConfig): {
