...
function hasChannels(cfg: TheClawConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: TheClawConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: TheClawConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: TheClawConfig): boolean {
...
function hasConfiguredSafeBins(cfg: TheClawConfig): boolean {
