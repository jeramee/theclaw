...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: TheClawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: TheClawConfig, deps?: BrowserDoctorDeps) {
  try {
