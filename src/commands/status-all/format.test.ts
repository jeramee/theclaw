...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://theclaw.local")).toBe("https://theclaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://theclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: theclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://theclaw.local" },
      ...
      { Item: "Security", Value: "Run: theclaw security audit --deep" },
