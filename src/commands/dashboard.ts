...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set THECLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `theclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control TheClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
