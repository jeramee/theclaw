...
async function resolveCatalogChannelEntry(raw: string, cfg: TheClawConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as TheClawConfig;
  ...
  // May trigger loadTheClawPlugins on cache miss (disk scan + jiti import)
