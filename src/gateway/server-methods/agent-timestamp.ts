 ...
 *
 * @see https://github.com/theclaw/theclaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an TheClawConfig.
 */
export function timestampOptsFromConfig(cfg: TheClawConfig): TimestampInjectionOptions {
  return {
