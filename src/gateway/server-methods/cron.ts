...
function listConfiguredAnnounceChannelIds(cfg: TheClawConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: TheClawConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: TheClawConfig, jobCreate: CronJobCreate) {
