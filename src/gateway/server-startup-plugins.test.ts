...
const resolveTheClawPackageRootSync = vi.hoisted(() => vi.fn((_params: unknown) => "/package"));
...
vi.mock("../infra/theclaw-root.js", () => ({
  resolveTheClawPackageRootSync: (params: unknown) => resolveTheClawPackageRootSync(params),
}));
...
describe("prepareGatewayPluginBootstrap runtime-deps staging", () => {
  beforeEach(() => {
    ...
    resolveTheClawPackageRootSync.mockClear().mockReturnValue("/package");
