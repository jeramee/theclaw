...
type GatewayInstallAuthMode = NonNullable<NonNullable<TheClawConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: TheClawConfig): boolean {
...
function hasDurableGatewayPasswordEnvForInstall(
  ...
  return Boolean(
    normalizeOptionalString(durableServiceEnv.THECLAW_GATEWAY_PASSWORD) ||
