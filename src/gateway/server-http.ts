        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __theclawPreauthBudgetClaimed?: boolean;
              __theclawPreauthBudgetKey?: string;
            }
          ).__theclawPreauthBudgetKey = preauthBudgetKey;
