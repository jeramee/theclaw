...
export function hasAmbiguousGatewayAuthModeConfig(cfg: TheClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: TheClawConfig): void {
