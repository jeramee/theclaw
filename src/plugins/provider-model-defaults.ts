...
export function applyGoogleGeminiModelDefault(cfg: TheClawConfig): {
  next: TheClawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: TheClawConfig): TheClawConfig {
...
export function applyOpenAIConfig(cfg: TheClawConfig): TheClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: TheClawConfig): {
  next: TheClawConfig;
  changed: boolean;
} {
