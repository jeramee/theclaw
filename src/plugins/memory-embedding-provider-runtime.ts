...
function readConfiguredProviderApiId(providerId: string, cfg?: TheClawConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: TheClawConfig): string[] {
  const ids = [id];
