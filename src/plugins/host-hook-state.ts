...
function loadPluginHostHookSessionEntry(params: { cfg: TheClawConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: TheClawConfig, pluginId: string): boolean {
