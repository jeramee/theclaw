...
describe("getCachedPluginJitiLoader", () => {
  ...
  it("normalizes Windows absolute paths before creating and calling jiti", async () => {
    ...
    const loader = getCachedPluginJitiLoader({
      cache,
      modulePath: "C:\\Users\\alice\\theclaw\\dist\\extensions\\feishu\\api.js",
      importerUrl: "file:///C:/Users/alice/theclaw/dist/src/plugins/public-surface-loader.js",
      jitiFilename: "C:\\Users\\alice\\theclaw\\dist\\extensions\\feishu\\api.js",
      tryNative: true,
    });

    loader("C:\\Users\\alice\\theclaw\\dist\\extensions\\feishu\\api.js");

    expect(createJiti).toHaveBeenCalledWith(
      "file:///C:/Users/alice/theclaw/dist/extensions/feishu/api.js",
  ...
  it("skips the native-require fast path when tryNative is explicitly false", async () => {
    ...
    const loader = getCachedPluginJitiLoader({
      ...
      aliasMap: { "theclaw/plugin-sdk": "/repo/shim.js" },
      tryNative: false,
    });
  ...
  it("normalizes Windows absolute paths when native loading is disabled", async () => {
    ...
    const loader = getCachedPluginJitiLoader({
      cache,
      modulePath: "C:\\Users\\alice\\theclaw\\extensions\\feishu\\api.ts",
      importerUrl: "file:///C:/Users/alice/theclaw/src/plugins/loader.ts",
      jitiFilename: "C:\\Users\\alice\\theclaw\\extensions\\feishu\\api.ts",
      tryNative: false,
    });

    loader("C:\\Users\\alice\\theclaw\\extensions\\feishu\\api.ts");

    expect(nativeStub).not.toHaveBeenCalled();
    expect(createJiti).toHaveBeenCalledWith(
      "file:///C:/Users/alice/theclaw/extensions/feishu/api.ts",
