...
import type { ClawdbotConfig, TheClawConfig, TheClawSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<TheClawConfig>();
    expectTypeOf<TheClawSchemaType>().toEqualTypeOf<TheClawConfig>();
  });
