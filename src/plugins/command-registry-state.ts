...
import type { TheClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = TheClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("theclaw.pluginCommandsState");
