...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by TheClaw from plugin manifests, install records, and config policy. Use `theclaw plugins registry --refresh`, `theclaw plugins install/update/uninstall`, or `theclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored theclaw.install metadata. This describes catalog/package
