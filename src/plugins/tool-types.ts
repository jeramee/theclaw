...
export type TheClawPluginToolContext = {
  ...
  getRuntimeConfig?: () => TheClawConfig | undefined;
...
export type TheClawPluginToolFactory = (
  ctx: TheClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type TheClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type TheClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
