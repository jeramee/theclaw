...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveTheClawAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: TheClawConfig): SecretRef {
