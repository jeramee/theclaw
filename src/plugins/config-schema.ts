...
import type { TheClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: TheClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): TheClawPluginConfigSchema {
  return {
