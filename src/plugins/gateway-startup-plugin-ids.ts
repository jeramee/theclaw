...
const DISABLE_LEGACY_IMPLICIT_STARTUP_SIDECARS_ENV =
  "THECLAW_DISABLE_LEGACY_IMPLICIT_STARTUP_SIDECARS";
...
function listPotentialEnabledChannelIds(config: TheClawConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: TheClawConfig): Set<string> {
