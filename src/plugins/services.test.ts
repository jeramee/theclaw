...
import type { TheClawPluginService, TheClawPluginServiceContext } from "./types.js";
...
function expectServiceContext(
  ctx: TheClawPluginServiceContext,
...
function expectServiceLogger(ctx: TheClawPluginServiceContext) {
...
function expectServiceContexts(
  contexts: TheClawPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: TheClawPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to bundled diagnostics exporter services", async () => {
    ...
    const prometheusContexts: TheClawPluginServiceContext[] = [];
    ...
    const untrustedContexts: TheClawPluginServiceContext[] = [];
