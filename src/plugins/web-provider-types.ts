...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: TheClawConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: TheClawConfig, value: unknown) => void;
  applySelectionConfig?: (config: TheClawConfig) => TheClawConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => TheClawConfig | Promise<TheClawConfig>;
