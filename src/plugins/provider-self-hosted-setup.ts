...
export function applyProviderDefaultModel(cfg: TheClawConfig, modelRef: string): TheClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: TheClawConfig; modelId: string; modelRef: string; profileId: string } {
