...
vi.mock("../discovery.js", () => ({
  discoverTheClawPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverTheClawPlugins>
  ) => registryJitiMocks.discoverTheClawPlugins(...args),
}));
