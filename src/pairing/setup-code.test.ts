...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("THECLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("THECLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("THECLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses THECLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          THECLAW_GATEWAY_TOKEN: "new-token",
        },
