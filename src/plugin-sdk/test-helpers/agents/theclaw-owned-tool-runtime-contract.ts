...
export function installTheClawOwnedToolHooks(params?: {
 ...
 * Pair with `installTheClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetTheClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
