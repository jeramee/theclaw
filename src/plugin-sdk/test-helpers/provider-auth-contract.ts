...
type LoginOpenAICodexOAuth =
  (typeof import("theclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("theclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type EnsureAuthProfileStore =
  typeof import("theclaw/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("theclaw/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("theclaw/plugin-sdk/provider-auth-login", async () => {
      const actual = await vi.importActual<
        typeof import("theclaw/plugin-sdk/provider-auth-login")
      >("theclaw/plugin-sdk/provider-auth-login");
      return {
        ...actual,
    ...
    vi.doMock("theclaw/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/provider-auth")>(
        "theclaw/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
