...
import type { TheClawPluginApi } from "../plugins/types.js";
...
export type { TheClawPluginToolContext, TheClawPluginToolFactory } from "../plugins/types.js";
export type {
...
export type { TheClawConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: TheClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
