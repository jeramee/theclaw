...
export { VERSION as THECLAW_VERSION } from "../version.js";
...
export { resolveTheClawAgentDir } from "../agents/agent-paths.js";
 ...
 * preserve the same TheClaw-owned fallback signals as the built-in PI path
