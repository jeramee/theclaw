...
export function resolveSessionToolsVisibility(cfg: TheClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: TheClawConfig): "spawned" | "all" {
  return cfg.agents?.defaults?.sandbox?.sessionToolsVisibility ?? "spawned";
}

export function createAgentToAgentPolicy(cfg: TheClawConfig): AgentToAgentPolicy {
