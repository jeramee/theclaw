...
const THECLAW_SOURCE_EXTENSIONS_ROOT = path.resolve(THECLAW_PACKAGE_ROOT, "extensions");
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  const bundledLocation = resolveBundledFacadeModuleLocation({
    ...
    packageRoot: THECLAW_PACKAGE_ROOT,
    bundledPluginsDir,
  });
  if (bundledLocation) {
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: THECLAW_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
