...
let cachedTheClawPackageRoot: string | undefined;
...
function getTheClawPackageRoot() {
  if (cachedTheClawPackageRoot) {
    return cachedTheClawPackageRoot;
  }
  cachedTheClawPackageRoot =
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getTheClawPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      location.boundaryRoot === getTheClawPackageRoot()
        ? "TheClaw package root"
        : (() => {
...
export async function loadBundledPluginPublicSurfaceModule<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      preparedLocation.boundaryRoot === getTheClawPackageRoot()
        ? "TheClaw package root"
        : "plugin root",
    rejectHardlinks: false,
  });
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedTheClawPackageRoot = undefined;
}
