...
const shouldWarnCompatImport =
  ...
  process.env.THECLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "theclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused theclaw/plugin-sdk/<subpath> imports. See https://docs.theclaw.ai/plugins/sdk-migration",
    {
      code: "THECLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.theclaw.ai/plugins/sdk-migration",
    },
  );
}
...
export { resolvePreferredTheClawTmpDir } from "./temp-path.js";
