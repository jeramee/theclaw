...
export type { TheClawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: TheClawConfig, ...args: TArgs) => TheClawConfig;
  applyConfig: (cfg: TheClawConfig, ...args: TArgs) => TheClawConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: TheClawConfig, preset: TParams) => TheClawConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: TheClawConfig): {
  next: TheClawConfig;
  changed: boolean;
} {
