...
export type { TheClawConfig } from "./config-types.js";
export type { TheClawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<TheClawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: TheClawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: TheClawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: TheClawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: TheClawConfig }): TheClawConfig {
...
export function listDiscordAccountIds(cfg: TheClawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: TheClawConfig): string {
