...
/** @deprecated Use TheClawConfig instead */
export type { TheClawConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use TheClawConfig instead */
export type { TheClawConfig as TheClawSchemaType } from "../config/config.js";
export type {
