...
type ChannelConfigAccessorParams<Config extends TheClawConfig = TheClawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends TheClawConfig = TheClawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends TheClawConfig = TheClawConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: TheClawConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends TheClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends TheClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends TheClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
