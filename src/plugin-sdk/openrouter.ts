...
import type { ModelProviderConfig, TheClawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: TheClawConfig) => TheClawConfig;
  applyOpenrouterProviderConfig: (cfg: TheClawConfig) => TheClawConfig;
