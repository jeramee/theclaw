...
function collectCandidateAgentDirs(
  ...
  dirs.add(resolveUserPath(resolveTheClawAgentDir(env), env));
...
function hasConfiguredPluginEntries(config: TheClawConfig): boolean {
...
function hasRuntimeWebToolConfigSurface(config: TheClawConfig): boolean {
