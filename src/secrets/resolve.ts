...
function resolveResolutionLimits(config: TheClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: TheClawConfig): SecretProviderConfig {
