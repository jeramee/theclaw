...
export function listAuthProfileStorePaths(config: TheClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: TheClawConfig, stateDir: string): string[] {
