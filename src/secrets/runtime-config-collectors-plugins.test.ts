...
function makeContext(sourceConfig: TheClawConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: TheClawConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: TheClawConfig): void {
