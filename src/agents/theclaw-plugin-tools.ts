...
import {
  resolveTheClawPluginToolInputs,
  type TheClawPluginToolOptions,
} from "./theclaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveTheClawPluginToolsOptions = TheClawPluginToolOptions & {
...
export function resolveTheClawPluginToolsForOptions(params: {
  options?: ResolveTheClawPluginToolsOptions;
