...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("theclaw.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: TheClawConfig): number {
