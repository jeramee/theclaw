...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.theclaw/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "theclaw doctor" and "theclaw approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
