...
// Keep the schema local to avoid a circular import through acp-spawn/theclaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: TheClawConfig }) {
