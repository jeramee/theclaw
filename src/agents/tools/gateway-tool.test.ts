...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: theclaw doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: theclaw doctor --non-interactive");
