...
import { resolveTheClawPluginToolsForOptions } from "./theclaw-plugin-tools.js";
import { applyNodesToolWorkspaceGuard } from "./theclaw-tools.nodes-workspace-guard.js";
import {
  collectPresentTheClawTools,
  isUpdatePlanToolEnabledForTheClawTools,
} from "./theclaw-tools.registration.js";
...
type TheClawToolsDeps = {
  callGateway: typeof callGateway;
  config?: TheClawConfig;
};

const defaultTheClawToolsDeps: TheClawToolsDeps = {
  callGateway,
};

let openClawToolsDeps: TheClawToolsDeps = defaultTheClawToolsDeps;

export function createTheClawTools(
  options?: {
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...collectPresentTheClawTools([imageGenerateTool, musicGenerateTool, videoGenerateTool]),
    ...(embedded
      ? []
      : [
          createGatewayTool({
    ...
    ...collectPresentTheClawTools([webSearchTool, webFetchTool, imageTool, pdfTool]),
  ];
  ...
  const wrappedPluginTools = resolveTheClawPluginToolsForOptions({
    options,
    resolvedConfig,
...
export const __testing = {
  setDepsForTest(overrides?: Partial<TheClawToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultTheClawToolsDeps,
          ...overrides,
        }
      : defaultTheClawToolsDeps;
  },
