...
function resolveAdaptiveReadMaxBytes(options?: TheClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createTheClawReadTool(base, {
...
export function createTheClawReadTool(
  base: AnyAgentTool,
  options?: TheClawReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
