...
type ModelsConfig = NonNullable<TheClawConfig["models"]>;
...
export async function planTheClawModelsJsonWithDeps(
  params: {
    cfg: TheClawConfig;
...
export async function planTheClawModelsJson(
  params: Parameters<typeof planTheClawModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planTheClawModelsJsonWithDeps(params);
}
