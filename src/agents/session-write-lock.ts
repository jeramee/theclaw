...
const CLEANUP_STATE_KEY = Symbol.for("theclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("theclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("theclaw.sessionWriteLockWatchdogState");
...
function shouldStartBackgroundWatchdog(): boolean {
  return process.env.VITEST !== "true" || process.env.THECLAW_TEST_SESSION_LOCK_WATCHDOG === "1";
}
