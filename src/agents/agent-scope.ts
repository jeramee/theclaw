...
function findMutableAgentEntry(cfg: TheClawConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: TheClawConfig, agentId: string): string | undefined {
