...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: TheClawConfig) => Promise<ContextEngine>;
};
...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.THECLAW_TEST_FAST === "1" ? 1_000 : 60_000;
...
async function resolveSubagentRegistryContextEngine(cfg: TheClawConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: TheClawConfig, runTimeoutSeconds?: number) {
