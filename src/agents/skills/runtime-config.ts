...
function hasConfiguredSkillApiKeyRef(config?: TheClawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: TheClawConfig): TheClawConfig | undefined {
