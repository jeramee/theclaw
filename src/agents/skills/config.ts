...
export function isConfigPathTruthy(config: TheClawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["theclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: TheClawConfig): string[] | undefined {
