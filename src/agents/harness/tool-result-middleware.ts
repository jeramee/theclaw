...
function isValidMiddlewareToolResult(value: unknown): value is TheClawAgentToolResult {
...
function buildMiddlewareFailureResult(): TheClawAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
export function createAgentToolResultMiddlewareRunner(
  ...
  return {
    ...
    ): Promise<TheClawAgentToolResult> {
