...
function redactTranscriptText(value: string, cfg?: TheClawConfig): string {
...
function redactTranscriptContentBlock(block: unknown, cfg?: TheClawConfig): unknown {
...
function redactTranscriptContent(content: unknown, cfg?: TheClawConfig): unknown {
...
function redactTranscriptMessage(message: AgentMessage, cfg?: TheClawConfig): AgentMessage {
