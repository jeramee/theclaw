...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "theclaw-openai-responses-transport",
  "openai-codex-responses": "theclaw-openai-responses-transport",
  "openai-completions": "theclaw-openai-completions-transport",
  "azure-openai-responses": "theclaw-azure-openai-responses-transport",
  "anthropic-messages": "theclaw-anthropic-messages-transport",
  "google-generative-ai": "theclaw-google-generative-ai-transport",
};
