...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.THECLAW_BUNDLED_PLUGINS_DIR;
  delete env.THECLAW_SKIP_PROVIDERS;
  delete env.THECLAW_SKIP_CHANNELS;
  delete env.THECLAW_SKIP_CRON;
  delete env.THECLAW_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
