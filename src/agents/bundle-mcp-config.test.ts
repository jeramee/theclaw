...
describe("loadMergedBundleMcpConfig", () => {
  it("lets TheClaw mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps TheClaw transports to downstream CLI types when requested", () => {
    expect(
