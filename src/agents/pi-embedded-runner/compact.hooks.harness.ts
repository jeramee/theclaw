...
export const createTheClawCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createTheClawCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveTheClawReferencePaths: vi.fn(async () => ({
      docsPath: undefined,
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveTheClawAgentDir: vi.fn(() => "/tmp"),
  }));
