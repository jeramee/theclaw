import {
  ...
  THECLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,
  THECLAW_RUNTIME_CONTEXT_NOTICE,
  THECLAW_RUNTIME_EVENT_HEADER,
} from "../../internal-runtime-context.js";
export { THECLAW_RUNTIME_CONTEXT_CUSTOM_TYPE };
...
export async function queueRuntimeContextForNextTurn(params: {
  ...
  await params.session.sendCustomMessage(
    {
      customType: THECLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,
      content: runtimeContext,
      display: false,
      details: { source: "theclaw-runtime-context" },
    },
    { deliverAs: "nextTurn" },
  );
}
