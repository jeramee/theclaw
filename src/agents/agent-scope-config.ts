...
export function listAgentEntries(cfg: TheClawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: TheClawConfig): string[] {
...
export function resolveDefaultAgentId(cfg: TheClawConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
