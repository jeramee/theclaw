...
export type TheClawStdioServerParameters = {
  command: string;
  args?: string[];
...
export class TheClawStdioClientTransport implements Transport {
  onclose?: () => void;
  ...
  constructor(private readonly serverParams: TheClawStdioServerParameters) {
  ...
  async start(): Promise<void> {
    if (this.process) {
      throw new Error(
        "TheClawStdioClientTransport already started; Client.connect() starts transports automatically.",
      );
    }
