...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/theclaw-sandbox",
    agentWorkspaceDir: "/tmp/theclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "theclaw-sbx-test",
    runtimeLabel: "theclaw-sbx-test",
    containerName: "theclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "theclaw-sbx-browser-test",
    },
