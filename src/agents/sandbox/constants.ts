...
export const DEFAULT_SANDBOX_IMAGE = "theclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "theclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "theclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "theclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "theclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "theclaw-sandbox-browser";
