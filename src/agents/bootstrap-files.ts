...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "theclaw:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: TheClawConfig): AgentContextInjection {
