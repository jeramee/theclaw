...
let runtimeConfigSnapshot: TheClawConfig | null = null;
let runtimeConfigSourceSnapshot: TheClawConfig | null = null;
...
function configSnapshotsMatch(left: TheClawConfig, right: TheClawConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: TheClawConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): TheClawConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: TheClawConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: TheClawConfig;
  runtimeConfig?: TheClawConfig | null;
  runtimeSourceConfig?: TheClawConfig | null;
}): TheClawConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => TheClawConfig): TheClawConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: TheClawConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => TheClawConfig;
