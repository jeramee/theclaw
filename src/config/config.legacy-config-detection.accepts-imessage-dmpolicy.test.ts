...
function expectTheClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = TheClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectTheClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = TheClawSchema.safeParse(config);
