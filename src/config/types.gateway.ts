...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "theclaw.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.theclaw/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/theclaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__theclaw__/canvas or /__theclaw__/a2ui content.
   */
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/theclaw/theclaw/issues/65485
   */
