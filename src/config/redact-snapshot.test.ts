...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/theclaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/theclaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/theclaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/theclaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/theclaw/nickserv-password.txt");
