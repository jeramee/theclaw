...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.THECLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.THECLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.THECLAW_WATCH_COMMAND),
