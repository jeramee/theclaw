...
export function applyMessageDefaults(cfg: TheClawConfig): TheClawConfig {
...
export function applyTalkConfigNormalization(config: TheClawConfig): TheClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: TheClawConfig): TheClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: TheClawConfig): TheClawConfig {
...
export function applyLoggingDefaults(cfg: TheClawConfig): TheClawConfig {
...
function hasAnthropicDefaultSignal(cfg: TheClawConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyContextPruningDefaults(cfg: TheClawConfig): TheClawConfig {
...
export function applyCompactionDefaults(cfg: TheClawConfig): TheClawConfig {
