...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): TheClawConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: TheClawConfig, env: NodeJS.ProcessEnv) =>
