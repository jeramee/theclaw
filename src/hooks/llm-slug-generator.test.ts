...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/theclaw-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/theclaw-agent/.theclaw-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: TheClawConfig) => {
