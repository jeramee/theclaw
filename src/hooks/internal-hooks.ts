/**
 * Hook system for TheClaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("theclaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("theclaw.internalHooksEnabled");
