...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "theclaw-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "theclaw-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "theclaw-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "theclaw-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "theclaw-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "theclaw-legacy-state");
    const configDir = path.join("/tmp", "theclaw-current-config");
