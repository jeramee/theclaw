...
export function resolveConfiguredMediaMaxBytes(cfg?: TheClawConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: TheClawConfig | undefined, kind: MediaKind) {
