...
function resolveCollectionNamesForAgent(cfg: TheClawConfig, agentId: string): Set<string> {
  return new Set(
...
function resolveCustomCollectionPathsForAgent(cfg: TheClawConfig, agentId: string): string[] {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as TheClawConfig;
