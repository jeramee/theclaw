    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["theclaw channels list", "List configured channels and auth profiles."],
          ["theclaw channels status --probe", "Run channel status checks and probes."],
          [
            "theclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["theclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.theclaw.ai/cli/channels",
        )}\n`,
    );
