...
import { readBestEffortConfig, type TheClawConfig } from "../config/config.js";
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.theclaw.ai/cli/approvals")}\n`,
    );
