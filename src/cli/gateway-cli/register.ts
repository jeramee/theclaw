      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["theclaw gateway run", "Run the gateway in the foreground."],
            ["theclaw gateway status", "Show service status plus connectivity/capability."],
            ["theclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["theclaw gateway stability", "Show recent stability diagnostics."],
            ["theclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.theclaw.ai/cli/gateway")}\n`,
      ),
  );
