...
type DaemonConfigContext = {
  ...
  cliCfg: TheClawConfig;
  daemonCfg: TheClawConfig;
...
function resolveSnapshotRuntimeConfig(snapshot: ConfigFileSnapshot | null): TheClawConfig | null {
...
function coerceStatusConfig(value: unknown): TheClawConfig {
