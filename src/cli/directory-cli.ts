    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["theclaw directory self --channel slack", "Show the connected account identity."],
          [
            'theclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["theclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "theclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.theclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
