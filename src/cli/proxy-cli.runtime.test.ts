...
describe("proxy cli runtime", () => {
  const envKeys = [
    "THECLAW_DEBUG_PROXY_DB_PATH",
    "THECLAW_DEBUG_PROXY_BLOB_DIR",
    "THECLAW_DEBUG_PROXY_CERT_DIR",
  ...
  beforeEach(() => {
    tempDir = mkdtempSync(path.join(os.tmpdir(), "theclaw-proxy-cli-runtime-"));
    ...
    process.env.THECLAW_DEBUG_PROXY_CERT_DIR = path.join(tempDir, "certs");
    delete process.env.THECLAW_DEBUG_PROXY_ENABLED;
    delete process.env.THECLAW_DEBUG_PROXY_SESSION_ID;
