...
function addInstalledPluginToAllowlist(cfg: TheClawConfig, pluginId: string): TheClawConfig {
...
function removeInstalledPluginFromDenylist(cfg: TheClawConfig, pluginId: string): TheClawConfig {
