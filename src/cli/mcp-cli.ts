...
import { serveTheClawChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage TheClaw MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose TheClaw channels over MCP stdio")
