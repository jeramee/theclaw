...
const SANDBOX_EXAMPLES = {
  main: [
    ["theclaw sandbox list", "List all sandbox containers."],
    ["theclaw sandbox list --browser", "List only browser containers."],
    ["theclaw sandbox recreate --all", "Recreate all containers."],
    ["theclaw sandbox recreate --session main", "Recreate a specific session."],
    ["theclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["theclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["theclaw sandbox list", "List all sandbox containers."],
    ["theclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["theclaw sandbox recreate --all", "Recreate all containers."],
    ["theclaw sandbox recreate --session main", "Recreate a specific session."],
    ["theclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["theclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["theclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["theclaw sandbox explain", "Show effective sandbox config."],
    ["theclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["theclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["theclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.theclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
