    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["theclaw", "Start Crestodian."],
          ["theclaw crestodian", "Start Crestodian explicitly."],
          ['theclaw crestodian -m "status"', "Run one status request."],
          [
            'theclaw crestodian -m "set default model openai/gpt-5.2" --yes',
