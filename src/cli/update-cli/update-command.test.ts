...
describe("resolveGatewayInstallEntrypointCandidates", () => {
  it("prefers index.js before legacy entry.js", () => {
    expect(resolveGatewayInstallEntrypointCandidates("/tmp/theclaw-root")).toEqual([
      path.join("/tmp/theclaw-root", "dist", "index.js"),
      path.join("/tmp/theclaw-root", "dist", "index.mjs"),
      path.join("/tmp/theclaw-root", "dist", "entry.js"),
      path.join("/tmp/theclaw-root", "dist", "entry.mjs"),
    ]);
  });
});
