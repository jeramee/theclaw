...
type TheClawReferencePaths = Awaited<ReturnType<typeof resolveTheClawReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveTheClawReferencePaths?: typeof resolveTheClawReferencePaths;
};
...
function buildAgentSummaries(cfg: TheClawConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): TheClawReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveTheClawReferencePaths ?? resolveTheClawReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: THECLAW_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: THECLAW_SOURCE_URL,
    },
  };
}
