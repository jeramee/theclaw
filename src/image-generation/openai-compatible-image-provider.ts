...
import { isProviderApiKeyConfigured } from "theclaw/plugin-sdk/provider-auth";
...
type ModelProviderConfig = NonNullable<NonNullable<TheClawConfig["models"]>["providers"]>[string];
