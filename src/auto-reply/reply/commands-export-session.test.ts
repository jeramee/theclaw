...
describe("buildExportSessionReply", () => {
  ...
  it("injects scripts and session data through the real export template", async () => {
    ...
    expect(html).not.toContain("data-theclaw-export-placeholder");
  ...
  it("preserves replacement text with dollar sequences", async () => {
    ...
    hoisted.exportHtmlTemplateContents.set(
      "template.html",
      [
        '<style data-theclaw-export-placeholder="CSS"></style>',
        '<script id="session-data" type="application/json" data-theclaw-export-placeholder="SESSION_DATA"></script>',
        '<script data-theclaw-export-placeholder="MARKED_JS"></script>',
        '<script data-theclaw-export-placeholder="HIGHLIGHT_JS"></script>',
        '<script data-theclaw-export-placeholder="JS"></script>',
      ].join(""),
    );
