...
function resolveMentionPatterns(cfg: TheClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: TheClawConfig | undefined, agentId?: string): RegExp[] {
