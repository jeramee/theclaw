...
type TheClawToolsRuntime = typeof import("../../agents/theclaw-tools.runtime.js");
...
let openClawToolsRuntimePromise: Promise<TheClawToolsRuntime> | undefined;
...
function loadTheClawToolsRuntime(): Promise<TheClawToolsRuntime> {
  openClawToolsRuntimePromise ??= import("../../agents/theclaw-tools.runtime.js");
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createTheClawTools } = await loadTheClawToolsRuntime();
