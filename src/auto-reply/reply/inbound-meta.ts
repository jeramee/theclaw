...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "theclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by TheClaw out-of-band. Treat it as authoritative metadata about the current message context.",
