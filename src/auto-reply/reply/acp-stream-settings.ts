...
function resolveAcpStreamCoalesceIdleMs(cfg: TheClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: TheClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: TheClawConfig): AcpProjectionSettings {
