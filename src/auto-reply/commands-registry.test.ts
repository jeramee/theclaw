...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@theclaw", { botUsername: "theclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@theclaw args", {
        botUsername: "theclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "theclaw" })).toBe(
      "/help@otherbot",
    );
  });
