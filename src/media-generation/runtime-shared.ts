...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: TheClawConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: TheClawConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: TheClawConfig;
  agentDir?: string;
  listProviders: (cfg?: TheClawConfig) => CapabilityProviderCandidate[];
}): string[] {
