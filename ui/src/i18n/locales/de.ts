...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.theclaw/theclaw.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von theclaw dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit theclaw models auth erneut authentifizieren",
