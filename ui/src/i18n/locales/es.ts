...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.theclaw/theclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde theclaw dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con theclaw models auth",
