...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/theclaw");
      expect(html).toContain('<a href="http://github.com/theclaw"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[TheClaw中文](https://docs.theclaw.ai)");
      expect(html).toContain('href="https://docs.theclaw.ai"');
      expect(html).toContain("TheClaw中文</a>");
    });
