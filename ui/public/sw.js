// TheClaw Control – Service Worker
// Handles offline caching and push notifications.

const CACHE_NAME = "theclaw-control-v1";
...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    data = { title: "TheClaw", body: event.data.text() };
  }

  const title = data.title || "TheClaw";
  const options = {
    body: data.body || "",
    icon: "./apple-touch-icon.png",
    badge: "./favicon-32.png",
    tag: data.tag || "theclaw-notification",
    data: { url: data.url || "./" },
  };
