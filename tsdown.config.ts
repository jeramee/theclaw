...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.THECLAW_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.THECLAW_BUILD_PRIVATE_QA === "1";
...
function shouldStageBundledPluginRuntimeDependencies(packageJson: unknown): boolean {
  return (
    ...
    packageJson !== null &&
    (packageJson as { theclaw?: { bundle?: { stageRuntimeDependencies?: boolean } } }).theclaw
...
function isPluginSdkSelfReference(id: string): boolean {
  return (
    id === "theclaw/plugin-sdk" ||
    id.startsWith("theclaw/plugin-sdk/") ||
    id === "@theclaw/plugin-sdk" ||
    id.startsWith("@theclaw/plugin-sdk/")
  );
}
