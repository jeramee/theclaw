...
const codexRepo = process.env.THECLAW_CODEX_REPO
  ? path.resolve(process.env.THECLAW_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches TheClaw bridge assumptions: ${schemaRoot}`,
);
