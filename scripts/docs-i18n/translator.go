...
const (
	...
	envDocsI18nPromptTimeout   = "THECLAW_DOCS_I18N_PROMPT_TIMEOUT"
	envDocsI18nCodexExecutable = "THECLAW_DOCS_I18N_CODEX_EXECUTABLE"
)
...
func runCodexExecPrompt(ctx context.Context, req codexPromptRequest) (string, error) {
	outputFile, err := os.CreateTemp("", "theclaw-docs-i18n-codex-*.txt")
	if err != nil {
		return "", err
	}
...
func isolatedCodexHomeBase() (string, error) {
	...
	base := filepath.Join(cacheDir, "theclaw-docs-i18n")
