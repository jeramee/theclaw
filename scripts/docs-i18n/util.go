...
const (
	...
	envDocsI18nProvider      = "THECLAW_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "THECLAW_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<theclaw_docs_i18n_input>", "</theclaw_docs_i18n_input>"} {
