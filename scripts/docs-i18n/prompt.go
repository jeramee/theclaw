...
- Keep product names in English: TheClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the TheClaw Gateway, use “Gateway 网关”.
