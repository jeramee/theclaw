...
const env = {
  ...process.env,
  THECLAW_LIVE_TEST: process.env.THECLAW_LIVE_TEST || "1",
  THECLAW_LIVE_TEST_QUIET: quietOverride ?? process.env.THECLAW_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.THECLAW_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
