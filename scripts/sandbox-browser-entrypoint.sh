...
export DISPLAY=:1
export HOME=/tmp/theclaw-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${THECLAW_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${THECLAW_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${THECLAW_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${THECLAW_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${THECLAW_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${THECLAW_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${THECLAW_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${THECLAW_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${THECLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${THECLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${THECLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${THECLAW_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set THECLAW_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
