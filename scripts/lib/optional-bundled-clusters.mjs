...
export const OPTIONAL_BUNDLED_BUILD_ENV = "THECLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.theclaw?.install?.npmSpec === "string" &&
    packageJson.theclaw.install.npmSpec.trim().length > 0
  );
}
