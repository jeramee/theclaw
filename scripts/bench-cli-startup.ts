...
const DEFAULT_ENTRY = "theclaw.mjs";
...
function printUsage(): void {
  console.log(`TheClaw CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: theclaw.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "theclaw-cli-bench-"));
