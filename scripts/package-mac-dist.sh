...
# Output:
# - dist/TheClaw.app
# - dist/TheClaw-<version>.zip
# - dist/TheClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.theclaw.mac}"
...
ZIP="$ROOT_DIR/dist/TheClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/TheClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/TheClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/TheClaw-$VERSION.dSYM.zip"
