...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-gateway-network-e2e" THECLAW_GATEWAY_NETWORK_E2E_IMAGE)"
SKIP_BUILD="${THECLAW_GATEWAY_NETWORK_E2E_SKIP_BUILD:-0}"

PORT="18789"
TOKEN="e2e-$(date +%s)-$$"
NET_NAME="theclaw-net-e2e-$$"
GW_NAME="theclaw-gateway-e2e-$$"
DOCKER_COMMAND_TIMEOUT="${THECLAW_GATEWAY_NETWORK_DOCKER_COMMAND_TIMEOUT:-600s}"
CLIENT_TIMEOUT="${THECLAW_GATEWAY_NETWORK_CLIENT_TIMEOUT:-90s}"
