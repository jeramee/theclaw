...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-session-runtime-context-e2e" THECLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="theclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t theclaw-session-runtime-context-log.XXXXXX)"
