...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-config-reload-e2e" THECLAW_CONFIG_RELOAD_E2E_IMAGE)"
SKIP_BUILD="${THECLAW_CONFIG_RELOAD_E2E_SKIP_BUILD:-0}"
PORT="18789"
TOKEN="reload-e2e-token"
CONTAINER_NAME="theclaw-config-reload-e2e-$$"
...
THECLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 config-reload empty)"
...
docker exec "$CONTAINER_NAME" bash -lc "source /tmp/theclaw-test-state-env
