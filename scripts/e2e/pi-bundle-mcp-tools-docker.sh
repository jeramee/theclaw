...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-pi-bundle-mcp-tools-e2e" THECLAW_IMAGE)"
CONTAINER_NAME="theclaw-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t theclaw-pi-bundle-mcp-tools-log.XXXXXX)"
...
THECLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 pi-bundle-mcp-tools empty)"
