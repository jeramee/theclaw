...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-crestodian-planner-e2e" THECLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="theclaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t theclaw-crestodian-planner-log.XXXXXX)"
...
THECLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
