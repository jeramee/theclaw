...
IMAGE_NAME="$(docker_e2e_resolve_image "theclaw-mcp-channels-e2e" THECLAW_IMAGE)"
PORT="18789"
TOKEN="mcp-e2e-$(date +%s)-$$"
CONTAINER_NAME="theclaw-mcp-e2e-$$"
CLIENT_LOG="$(mktemp -t theclaw-mcp-client-log.XXXXXX)"
...
THECLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 mcp-channels empty)"
