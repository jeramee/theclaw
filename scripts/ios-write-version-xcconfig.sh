...
- THECLAW_IOS_VERSION = exact canonical iOS version
- THECLAW_MARKETING_VERSION = short iOS/App Store version
- THECLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
THECLAW_IOS_VERSION = ${IOS_VERSION}
THECLAW_MARKETING_VERSION = ${MARKETING_VERSION}
THECLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
