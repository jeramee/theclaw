import type { ChannelDoctorLegacyConfigRule } from "theclaw/plugin-sdk/channel-contract";
import type { TheClawConfig } from "theclaw/plugin-sdk/config-types";
import { isRecord } from "theclaw/plugin-sdk/text-runtime";
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: TheClawConfig }): {
