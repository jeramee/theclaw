...
function resolveTheClawVersion(): string {
  try {
 ...
 * and appends the TheClaw version.
 *
 * Format: "teams.ts[apps]/<sdk-version> TheClaw/<theclaw-version>"
 * Example: "teams.ts[apps]/2.0.5 TheClaw/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} TheClaw/${resolveTheClawVersion()}`;
  return cachedUserAgent;
}
