import { describeAccountSnapshot } from "theclaw/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "theclaw/plugin-sdk/allow-from";
import { createTopLevelChannelConfigAdapter } from "theclaw/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "theclaw/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "theclaw/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "theclaw/plugin-sdk/channel-pairing";
import {
...
} from "theclaw/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "theclaw/plugin-sdk/interactive-runtime";
import { createLazyRuntimeNamedExport } from "theclaw/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "theclaw/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "theclaw/plugin-sdk/status-helpers";
import { normalizeOptionalString } from "theclaw/plugin-sdk/text-runtime";
import { Type } from "typebox";
import type { ChannelMessageActionName, ChannelPlugin, TheClawConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: TheClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: TheClawConfig }>(
