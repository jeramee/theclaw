import { createSendCfgThreadingRuntime } from "theclaw/plugin-sdk/channel-test-helpers";
...
vi.mock("theclaw/plugin-sdk/plugin-config-runtime", async () => {
  const original = (await vi.importActual("theclaw/plugin-sdk/plugin-config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("theclaw/plugin-sdk/text-runtime", async () => {
  const original = (await vi.importActual("theclaw/plugin-sdk/text-runtime")) as Record<
    string,
    unknown
  >;
  return {
