...
} from "theclaw/plugin-sdk/image-generation";
import {
  parseOpenAiCompatibleImageResponse,
  toImageDataUrl,
} from "theclaw/plugin-sdk/image-generation";
import { createSubsystemLogger } from "theclaw/plugin-sdk/logging-core";
import { resolveClosestSize } from "theclaw/plugin-sdk/media-generation-runtime";
import {
...
import { resolveApiKeyForProvider } from "theclaw/plugin-sdk/provider-auth-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.THECLAW_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: TheClawConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: TheClawConfig | undefined): boolean {
