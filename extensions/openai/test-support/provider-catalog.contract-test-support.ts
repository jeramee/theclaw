...
import type { ProviderPlugin } from "theclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("theclaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("theclaw/plugin-sdk/provider-catalog-runtime")
  >("theclaw/plugin-sdk/provider-catalog-runtime");
