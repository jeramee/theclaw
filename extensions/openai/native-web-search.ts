...
import { streamWithPayloadPatch } from "theclaw/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: TheClawConfig | undefined): boolean {
