...
function mergeZaloAccountConfig(cfg: TheClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: TheClawConfig): ResolvedZaloAccount[] {
