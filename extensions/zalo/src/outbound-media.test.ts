...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under TheClaw control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredTheClawTmpDir(), "theclaw-zalo-outbound-media");
