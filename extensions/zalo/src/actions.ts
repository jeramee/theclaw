import { jsonResult, readStringParam } from "theclaw/plugin-sdk/channel-actions";
import type {
...
import { extractToolSend } from "theclaw/plugin-sdk/tool-send";
...
function listEnabledAccounts(cfg: TheClawConfig, accountId?: string | null) {
  return (
