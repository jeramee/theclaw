...
const DISCORD_QA_CAPTURE_CONTENT_ENV = "THECLAW_QA_DISCORD_CAPTURE_CONTENT";
...
const DISCORD_QA_ENV_KEYS = [
  ...
  "THECLAW_QA_DISCORD_SUT_APPLICATION_ID",
] as const;
...
export function resolveDiscordQaRuntimeEnv(
  ...
  const runtimeEnv = {
    guildId: resolveEnvValue(env, "THECLAW_QA_DISCORD_GUILD_ID"),
    channelId: resolveEnvValue(env, "THECLAW_QA_DISCORD_CHANNEL_ID"),
    driverBotToken: resolveEnvValue(env, "THECLAW_QA_DISCORD_DRIVER_BOT_TOKEN"),
    sutBotToken: resolveEnvValue(env, "THECLAW_QA_DISCORD_SUT_BOT_TOKEN"),
    sutApplicationId: resolveEnvValue(env, "THECLAW_QA_DISCORD_SUT_APPLICATION_ID"),
  };
  validateDiscordQaRuntimeEnv(runtimeEnv, "THECLAW_QA_DISCORD");
  return runtimeEnv;
}
