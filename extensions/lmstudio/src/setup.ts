...
import { withAgentModelAliases } from "theclaw/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: TheClawConfig): TheClawConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<TheClawConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
