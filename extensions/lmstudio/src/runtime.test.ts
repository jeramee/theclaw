...
vi.mock("theclaw/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("theclaw/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
