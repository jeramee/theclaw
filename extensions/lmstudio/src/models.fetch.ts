...
import { SELF_HOSTED_DEFAULT_COST } from "theclaw/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "theclaw/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to TheClaw model definitions. */
