...
function normalizeDenyList(cfg: TheClawPluginApi["config"]): string[] {
  return uniqSorted([...(cfg.gateway?.nodes?.denyCommands ?? [])]);
}

function normalizeAllowList(cfg: TheClawPluginApi["config"]): string[] {
...
export default definePluginEntry({
  ...
  register(api: TheClawPluginApi) {
    ...
    const timerService: TheClawPluginService = {
