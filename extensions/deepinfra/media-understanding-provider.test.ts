...
vi.mock("theclaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/media-understanding")>(
    "theclaw/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
