import { createProviderUsageFetch, makeResponse } from "theclaw/plugin-sdk/test-env";
...
vi.mock("theclaw/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("theclaw/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/theclaw-state",
}));

import type { ProviderResolveDynamicModelContext } from "theclaw/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/theclaw-state/credentials/github-copilot.token.json";
