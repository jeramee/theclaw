...
import { buildOauthProviderAuthResult } from "theclaw/plugin-sdk/provider-auth";
import { createProviderApiKeyAuthMethod } from "theclaw/plugin-sdk/provider-auth-api-key";
import { buildProviderReplayFamilyHooks } from "theclaw/plugin-sdk/provider-model-shared";
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "theclaw/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "theclaw/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: TheClawPluginApi) {
