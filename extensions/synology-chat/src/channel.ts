/**
 * Synology Chat Channel Plugin for TheClaw.
 *
...
import { waitUntilAbort } from "theclaw/plugin-sdk/channel-lifecycle";
import {
...
import { createEmptyChannelDirectoryAdapter } from "theclaw/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "theclaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: TheClawConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: TheClawConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to TheClaw",
        order: 90,
      },
      capabilities: {
