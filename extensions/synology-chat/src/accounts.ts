...
import { resolveDangerousNameMatchingEnabled } from "theclaw/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full TheClaw config object. */
function getChannelConfig(cfg: TheClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: TheClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.THECLAW_BOT_NAME ?? "TheClaw";
