...
vi.mock("theclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("theclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("theclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("theclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("theclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("theclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
