import { DEFAULT_ACCOUNT_ID, type TheClawConfig } from "theclaw/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "theclaw/plugin-sdk/webhook-ingress";
