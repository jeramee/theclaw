...
This package contains the **BlueBubbles external channel plugin** for TheClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `theclaw/plugin-sdk` helpers.
