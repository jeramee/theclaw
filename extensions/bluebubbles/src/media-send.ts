...
import {
  ...
  safeFileURLToPath,
} from "theclaw/plugin-sdk/file-access-runtime";
import { resolveChannelMediaMaxBytes } from "theclaw/plugin-sdk/media-runtime";
import { lowercasePreservingWhitespace } from "theclaw/plugin-sdk/text-runtime";
...
function resolveMediaLocalRoots(params: { cfg: TheClawConfig; accountId?: string }): string[] {
