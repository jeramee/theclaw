...
import { collectIssuesForEnabledAccounts } from "theclaw/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: theclaw channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
