...
function resolveGoogleChatAccountImpl(params: { cfg: TheClawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: TheClawConfig) => {
...
function createGoogleChatCfg(): TheClawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
