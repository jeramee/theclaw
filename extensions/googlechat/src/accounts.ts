...
import { safeParseJsonWithSchema, safeParseWithSchema } from "theclaw/plugin-sdk/extension-shared";
import { isSecretRef } from "theclaw/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: TheClawConfig): ResolvedGoogleChatAccount[] {
