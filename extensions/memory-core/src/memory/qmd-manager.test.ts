...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("theclaw.memoryEmbeddingProviders");
const MCPORTER_STATE_KEY = Symbol.for("theclaw.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("theclaw.qmdEmbedQueueTail");
...
vi.mock("theclaw/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("theclaw/plugin-sdk/memory-core-host-engine-foundation")
  >("theclaw/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("theclaw/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/file-lock")>(
    "theclaw/plugin-sdk/file-lock",
  );
  return {
    ...actual,
