...
import type { MemoryEmbeddingProviderAdapter } from "theclaw/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("theclaw/plugin-sdk/memory-core-host-engine-embeddings", () => ({
