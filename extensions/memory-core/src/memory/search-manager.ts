...
import { checkQmdBinaryAvailability } from "theclaw/plugin-sdk/memory-core-host-engine-qmd";
import {
...
import { normalizeAgentId } from "theclaw/plugin-sdk/routing";

const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("theclaw.memorySearchManagerCache");
type Maybe<T> = T | null;
