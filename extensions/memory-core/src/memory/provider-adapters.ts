...
import { resolveUserPath } from "theclaw/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "theclaw/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install optional local embedding runtime next to TheClaw: npm i -g ${NODE_LLAMA_CPP_INSTALL_SPEC}`
      : null,
