...
import { createAsyncLock } from "theclaw/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "theclaw/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- theclaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- theclaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "theclaw:dreaming:backfill-entry";
