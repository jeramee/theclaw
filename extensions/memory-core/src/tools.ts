...
import type { MemorySource } from "theclaw/plugin-sdk/memory-core-host-engine-storage";
import {
  asToolParamsRecord,
  jsonResult,
  readNumberParam,
  readStringParam,
  type TheClawConfig,
} from "theclaw/plugin-sdk/memory-core-host-runtime-core";
import type {
  MemorySearchResult,
  MemorySearchRuntimeDebug,
} from "theclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
export function createMemorySearchTool(options: {
  ...
  getConfig?: () => TheClawConfig | undefined;
  agentSessionKey?: string;
  sandboxed?: boolean;
}) {
