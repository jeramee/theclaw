...
import {
  ...
  sessionPathForFile,
} from "theclaw/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "theclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
import type { TheClawPluginApi } from "theclaw/plugin-sdk/plugin-entry";
...
type Logger = Pick<TheClawPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__theclaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__theclaw_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- theclaw:dreaming:light:start -->",
    endMarker: "<!-- theclaw:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- theclaw:dreaming:rem:start -->",
    endMarker: "<!-- theclaw:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: TheClawPluginApi): void {
