...
import type { TheClawPluginService, TheClawPluginServiceContext } from "theclaw/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: TheClawPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpxRuntimeLike | null;
  realService: TheClawPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpxRuntimeLike> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as TheClawPluginServiceContext);
