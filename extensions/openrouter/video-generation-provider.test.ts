import { expectExplicitVideoGenerationCapabilities } from "theclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("theclaw/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: resolveApiKeyForProviderMock,
}));

vi.mock("theclaw/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/provider-http")>(
    "theclaw/plugin-sdk/provider-http",
  );
  return {
    ...actual,
