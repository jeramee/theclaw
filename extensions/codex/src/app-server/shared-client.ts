import { resolveTheClawAgentDir } from "theclaw/plugin-sdk/provider-auth";
...
const SHARED_CODEX_APP_SERVER_CLIENT_STATE = Symbol.for("theclaw.codexAppServerClientState");
