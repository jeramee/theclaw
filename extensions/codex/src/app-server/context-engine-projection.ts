import type { AgentMessage } from "theclaw/plugin-sdk/agent-harness-runtime";
...
const CONTEXT_HEADER = "TheClaw assembled context for this turn:";
...
/**
 * Project assembled TheClaw context-engine messages into Codex prompt inputs.
 */
