...
import { createMigrationItem, MIGRATION_REASON_TARGET_EXISTS } from "theclaw/plugin-sdk/migration";
import type { MigrationItem } from "theclaw/plugin-sdk/plugin-entry";
