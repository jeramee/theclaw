...
import type { ModelDefinitionConfig } from "theclaw/plugin-sdk/provider-onboard";
import { withFetchPreconnect } from "theclaw/plugin-sdk/test-env";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "theclaw-test-"));
  ...
  async function runOllamaCatalog(params: { config?: TheClawConfig; env?: NodeJS.ProcessEnv }) {
