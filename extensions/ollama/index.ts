...
import { buildApiKeyCredential } from "theclaw/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: TheClawPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: TheClawConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "theclaw configure". ' +
        "See: https://docs.theclaw.ai/providers/ollama",
    });
  },
});
