...
import { jsonResponse, requestBodyText, requestUrl } from "theclaw/plugin-sdk/test-env";
...
vi.mock("theclaw/plugin-sdk/ssrf-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("theclaw/plugin-sdk/ssrf-runtime")>();
  return {
    ...actual,
