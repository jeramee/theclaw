...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: TheClawConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: TheClawConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: TheClawConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure TheClaw has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: TheClawConfig; accountId?: string }) =>
