...
import { createChannelPairingChallengeIssuer } from "theclaw/plugin-sdk/channel-pairing";
...
import { normalizeScpRemoteHost } from "theclaw/plugin-sdk/host-runtime";
import { isInboundPathAllowed, kindFromMime } from "theclaw/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "theclaw/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "theclaw/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "theclaw/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "theclaw/plugin-sdk/reply-runtime";
import { getRuntimeConfig } from "theclaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "theclaw/plugin-sdk/runtime-env";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "theclaw/plugin-sdk/runtime-group-policy";
import { resolvePinnedMainDmOwnerFromAllowlist } from "theclaw/plugin-sdk/security-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "theclaw/plugin-sdk/session-store-runtime";
import { truncateUtf16Safe } from "theclaw/plugin-sdk/text-runtime";
import { waitForTransportReady } from "theclaw/plugin-sdk/transport-ready-runtime";
 ...
 *   exec ssh -T theclaw@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., theclaw@192.168.64.3)
