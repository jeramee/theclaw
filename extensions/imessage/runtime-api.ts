import type { TheClawConfig as RuntimeApiTheClawConfig } from "theclaw/plugin-sdk/config-types";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiTheClawConfig["channels"]>["imessage"]>,
