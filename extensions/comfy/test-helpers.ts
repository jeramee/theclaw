...
export function buildComfyConfig(config: Record<string, unknown>): TheClawConfig {
  return {
    plugins: {
      entries: {
        comfy: { config },
...
export function buildLegacyComfyConfig(config: Record<string, unknown>): TheClawConfig {
  return {
    models: {
      providers: {
        comfy: config,
