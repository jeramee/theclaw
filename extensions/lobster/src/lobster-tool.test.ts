...
import type { TheClawPluginApi, TheClawPluginToolContext } from "../runtime-api.js";
import { createLobsterTool } from "./lobster-tool.js";
import { createFakeTaskFlow } from "./taskflow-test-helpers.js";

function fakeApi(overrides: Partial<TheClawPluginApi> = {}): TheClawPluginApi {
...
function fakeCtx(overrides: Partial<TheClawPluginToolContext> = {}): TheClawPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: TheClawPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
