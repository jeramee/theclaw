export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "theclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "theclaw/plugin-sdk/reply-runtime";
