...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "theclaw/plugin-sdk/config-types";
import { resolveOAuthDir } from "theclaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: TheClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: TheClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: TheClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: TheClawConfig): ResolvedWhatsAppAccount[] {
