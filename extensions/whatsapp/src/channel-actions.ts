...
function areWhatsAppAgentReactionsEnabled(params: { cfg: TheClawConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: TheClawConfig) {
