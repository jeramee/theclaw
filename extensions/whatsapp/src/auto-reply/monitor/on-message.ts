import type { AckReactionHandle } from "theclaw/plugin-sdk/channel-feedback";
import type { getReplyFromConfig } from "theclaw/plugin-sdk/reply-runtime";
import type { MsgContext } from "theclaw/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "theclaw/plugin-sdk/routing";
import { buildGroupHistoryKey } from "theclaw/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("theclaw/plugin-sdk/runtime-env"))["getChildLogger"]>;
