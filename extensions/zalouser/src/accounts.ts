...
function mergeZalouserAccountConfig(cfg: TheClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: TheClawConfig; accountId?: string | null }) {
