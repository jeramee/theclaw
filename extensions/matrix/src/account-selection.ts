...
import { hasConfiguredSecretInput } from "theclaw/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: TheClawConfig): Record<string, unknown> | null {
