...
import { buildPluginApprovalResolvedReplyPayload } from "theclaw/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// TheClaw Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.theclaw.approval" as const;
