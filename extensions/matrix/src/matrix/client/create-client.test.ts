...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/theclaw-matrix-create-client-test",
    storagePath: "/tmp/theclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/theclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/theclaw-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/theclaw-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "theclaw-matrix-default-token-hash",
