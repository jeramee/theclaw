import type { TheClawPluginApi as MatrixEntryPluginApi } from "theclaw/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("theclaw/plugin-sdk/conversation-binding-runtime", () => ({
