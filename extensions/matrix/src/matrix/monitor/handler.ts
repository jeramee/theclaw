...
import type { GetReplyOptions } from "theclaw/plugin-sdk/reply-runtime";
import {
  loadSessionStore,
  resolveSessionStoreEntry,
} from "theclaw/plugin-sdk/session-store-runtime";
import { normalizeOptionalString } from "theclaw/plugin-sdk/string-coerce-runtime";
import type {
  CoreConfig,
  MatrixRoomConfig,
  MatrixStreamingMode,
...
import { MATRIX_THECLAW_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("theclaw/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("theclaw/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("theclaw/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("theclaw/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("theclaw/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("theclaw/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_THECLAW_FINALIZED_PREVIEW_KEY]: true };
}
