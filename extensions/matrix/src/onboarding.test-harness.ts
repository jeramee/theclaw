import type { OutputRuntimeEnv } from "theclaw/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "theclaw/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "TheClaw Gateway",
    },
    confirm: {
