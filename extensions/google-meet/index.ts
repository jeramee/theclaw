...
} from "theclaw/plugin-sdk/gateway-runtime";
...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through TheClaw browser automation.",
    },
    ...
    "realtime.agentId": {
      ...
      help: 'TheClaw agent id used by theclaw_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
