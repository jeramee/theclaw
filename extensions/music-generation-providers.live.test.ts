...
const providerFilter = parseCsvFilter(process.env.THECLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.THECLAW_LIVE_MUSIC_GENERATION_MODELS);
