import { REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ } from "theclaw/plugin-sdk/realtime-voice";
...
describe("buildGoogleRealtimeVoiceProvider", () => {
  ...
  it("keeps Google Live consult calls open after continuing tool responses", async () => {
    ...
    lastConnectParams().callbacks.onmessage({
      ...
      toolCall: {
        functionCalls: [
          { id: "consult-call", name: "theclaw_agent_consult", args: { prompt: "hi" } },
        ],
      },
    });
