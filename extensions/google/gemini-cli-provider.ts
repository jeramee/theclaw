...
import { buildOauthProviderAuthResult } from "theclaw/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "theclaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: TheClawPluginApi) {
