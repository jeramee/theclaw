...
export const discordChannelConfigUiHints = {
  ...
  "eventQueue.listenerTimeout": {
    ...
    help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in TheClaw; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
  },
  ...
  gatewayInfoTimeoutMs: {
    ...
    help: "Timeout for Discord /gateway/bot metadata lookup before falling back to the default gateway URL. Default is 30000; THECLAW_DISCORD_GATEWAY_INFO_TIMEOUT_MS can override when config is unset.",
  },
  "voice.enabled": {
