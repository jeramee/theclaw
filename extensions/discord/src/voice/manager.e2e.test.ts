...
vi.mock("theclaw/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/routing")>(
    "theclaw/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("theclaw/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/agent-runtime")>(
    "theclaw/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
