...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("theclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("theclaw.discord.modalEntries");
