...
import { sleepWithAbort } from "theclaw/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "theclaw/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "theclaw/plugin-sdk/target-resolver-runtime";
import {
...
function resolveDiscordStartupDelayMs(cfg: TheClawConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). TheClaw adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
