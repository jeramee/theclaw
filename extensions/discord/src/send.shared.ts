...
import type { ChunkMode } from "theclaw/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "theclaw/plugin-sdk/reply-payload";
import type { RetryRunner } from "theclaw/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: TheClawConfig },
): Promise<{ channelId: string; dm?: boolean }> {
