...
describe("discord config schema", () => {
  ...
  it("loads guild map and dm group settings", () => {
    ...
    expect(cfg.dm?.groupChannels).toEqual(["theclaw-dm"]);
    ...
    expect(cfg.guilds?.["123"]?.slug).toBe("friends-of-theclaw");
  ...
  it.each([
    ...
    },
    {
      ...
      config: { activity: "Live", activityUrl: "https://twitch.tv/theclaw" },
    },
    {
