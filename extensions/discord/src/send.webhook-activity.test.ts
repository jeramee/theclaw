...
vi.mock("theclaw/plugin-sdk/channel-activity-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("theclaw/plugin-sdk/channel-activity-runtime")
  >("theclaw/plugin-sdk/channel-activity-runtime");
  return {
    ...actual,
