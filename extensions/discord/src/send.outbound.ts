...
import type { MarkdownTableMode, TheClawConfig } from "theclaw/plugin-sdk/config-types";
import { resolveMarkdownTableMode } from "theclaw/plugin-sdk/markdown-table-runtime";
import { maxBytesForKind } from "theclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "theclaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "theclaw/plugin-sdk/media-runtime";
import type { PollInput } from "theclaw/plugin-sdk/media-runtime";
import { requireRuntimeConfig } from "theclaw/plugin-sdk/plugin-config-runtime";
import { resolveChunkMode, type ChunkMode } from "theclaw/plugin-sdk/reply-chunking";
import type { RetryConfig } from "theclaw/plugin-sdk/retry-runtime";
import { resolvePreferredTheClawTmpDir } from "theclaw/plugin-sdk/temp-path";
import { convertMarkdownTables, normalizeOptionalString } from "theclaw/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "theclaw/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredTheClawTmpDir();
