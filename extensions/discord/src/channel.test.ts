...
function createCfg(): TheClawConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: TheClawConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: TheClawConfig, accountId = "default") {
