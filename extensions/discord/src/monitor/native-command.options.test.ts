...
let listNativeCommandSpecs: typeof import("theclaw/plugin-sdk/command-auth").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    cfg?: TheClawConfig;
    discordConfig?: NonNullable<TheClawConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: TheClawConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<TheClawConfig["channels"]>["discord"] =
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("theclaw/plugin-sdk/command-auth"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<TheClawConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<TheClawConfig["channels"]>["discord"];
