...
import * as pluginCommandsModule from "theclaw/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "theclaw/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: TheClawConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: TheClawConfig) => void;
