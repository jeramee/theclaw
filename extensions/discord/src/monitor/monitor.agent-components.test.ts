...
import { peekSystemEvents, resetSystemEventsForTest } from "theclaw/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): TheClawConfig => ({}) as TheClawConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`theclaw pairing approve discord ${code}`);
