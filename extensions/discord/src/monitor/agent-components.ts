...
import { resolveHumanDelayConfig } from "theclaw/plugin-sdk/agent-runtime";
import {
...
import { createNonExitingRuntime, logVerbose } from "theclaw/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "theclaw/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "theclaw/plugin-sdk/text-runtime";
...
let replyPipelineRuntimePromise:
  | Promise<typeof import("theclaw/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("theclaw/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__theclaw_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__theclaw_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__theclaw_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__theclaw_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__theclaw_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__theclaw_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "TheClaw form";
  customId = "__theclaw_discord_component_modal_wildcard__";
  components = [];
