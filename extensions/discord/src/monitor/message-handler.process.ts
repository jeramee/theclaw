...
import { deliverFinalizableDraftPreview } from "theclaw/plugin-sdk/channel-lifecycle";
import {
  createChannelReplyPipeline,
  resolveChannelSourceReplyDeliveryMode,
} from "theclaw/plugin-sdk/channel-reply-pipeline";
import {
  resolveChannelStreamingBlockEnabled,
  resolveChannelStreamingPreviewToolProgress,
} from "theclaw/plugin-sdk/channel-streaming";
import { resolveChannelContextVisibilityMode } from "theclaw/plugin-sdk/context-visibility-runtime";
import { recordInboundSession } from "theclaw/plugin-sdk/conversation-runtime";
import { isDangerousNameMatchingEnabled } from "theclaw/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "theclaw/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "theclaw/plugin-sdk/media-runtime";
import { resolveChunkMode } from "theclaw/plugin-sdk/reply-chunking";
import type { ReplyPayload } from "theclaw/plugin-sdk/reply-dispatch-runtime";
import { finalizeInboundContext } from "theclaw/plugin-sdk/reply-dispatch-runtime";
import {
  buildPendingHistoryContextFromMap,
  clearHistoryEntriesIfEnabled,
} from "theclaw/plugin-sdk/reply-history";
import { resolveSendableOutboundReplyParts } from "theclaw/plugin-sdk/reply-payload";
import { buildAgentSessionKey, resolveThreadSessionKeys } from "theclaw/plugin-sdk/routing";
import { danger, logVerbose, shouldLogVerbose } from "theclaw/plugin-sdk/runtime-env";
import { evaluateSupplementalContextVisibility } from "theclaw/plugin-sdk/security-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "theclaw/plugin-sdk/session-store-runtime";
import {
  convertMarkdownTables,
  stripInlineDirectiveTagsForDelivery,
  stripReasoningTagsFromText,
  truncateUtf16Safe,
} from "theclaw/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("theclaw/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("theclaw/plugin-sdk/reply-runtime");
