...
import type { SessionBindingRecord } from "theclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "theclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "theclaw/plugin-sdk/routing";
...
export type LoadedConfig = TheClawConfig;
export type RuntimeEnv = import("theclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("theclaw/plugin-sdk/config-types").TheClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
