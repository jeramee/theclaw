...
import type { NativeCommandSpec } from "theclaw/plugin-sdk/command-auth";
...
import { dispatchReplyWithDispatcher } from "theclaw/plugin-sdk/reply-dispatch-runtime";
...
async function createNativeCommand(cfg: TheClawConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: TheClawConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: TheClawConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("theclaw/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("theclaw/plugin-sdk/plugin-runtime").executePluginCommand,
    );
