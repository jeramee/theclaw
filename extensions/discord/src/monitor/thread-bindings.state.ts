...
import { loadJsonFile, saveJsonFile } from "theclaw/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "theclaw/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("theclaw.discordThreadBindingsState");
