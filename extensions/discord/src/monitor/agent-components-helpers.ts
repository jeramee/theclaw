...
import { resolveCommandAuthorizedFromAuthorizers } from "theclaw/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, TheClawConfig } from "theclaw/plugin-sdk/config-types";
...
import { logError } from "theclaw/plugin-sdk/text-runtime";
import {
