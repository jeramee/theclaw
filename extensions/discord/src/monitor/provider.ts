...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "theclaw/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "theclaw/plugin-sdk/channel-contract";
import { registerChannelRuntimeContext } from "theclaw/plugin-sdk/channel-runtime-context";
import {
  listNativeCommandSpecsForConfig,
  listSkillCommandsForAgents,
  type NativeCommandSpec,
} from "theclaw/plugin-sdk/command-auth";
import type { TheClawConfig, ReplyToMode } from "theclaw/plugin-sdk/config-types";
import { createConnectedChannelStatusPatch } from "theclaw/plugin-sdk/gateway-runtime";
import {
  isNativeCommandsExplicitlyDisabled,
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "theclaw/plugin-sdk/native-command-config-runtime";
import { resolveTextChunkLimit } from "theclaw/plugin-sdk/reply-chunking";
...
import { createSubsystemLogger } from "theclaw/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "theclaw/plugin-sdk/runtime-env";
import {
...
type GetPluginCommandSpecs =
  typeof import("theclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
...
let pluginRuntimePromise: Promise<typeof import("theclaw/plugin-sdk/plugin-runtime")> | undefined;
...
async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("theclaw/plugin-sdk/plugin-runtime");
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("theclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();
