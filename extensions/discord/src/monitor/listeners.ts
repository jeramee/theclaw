...
type LoadedConfig = TheClawConfig;
type RuntimeEnv = import("theclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("theclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
