...
import { collectProviderDangerousNameMatchingScopes } from "theclaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: TheClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: TheClawConfig,
  doctorFixCommand: string,
): { config: TheClawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: TheClawConfig): string[] {
