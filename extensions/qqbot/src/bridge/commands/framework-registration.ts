...
import type { TheClawPluginApi, PluginCommandContext } from "theclaw/plugin-sdk/plugin-entry";
...
export function registerQQBotFrameworkCommands(api: TheClawPluginApi): void {
