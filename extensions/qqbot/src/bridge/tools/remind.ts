import { callGatewayTool } from "theclaw/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  TheClawPluginApi,
...
export function createRemindTool(
  toolContext: TheClawPluginToolContext = {},
...
export function registerRemindTool(api: TheClawPluginApi): void {
