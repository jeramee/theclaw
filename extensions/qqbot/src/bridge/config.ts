...
export function listQQBotAccountIds(cfg: TheClawConfig): string[] {
  return listAccountIds(cfg as unknown as Record<string, unknown>);
}

/** Resolve the default QQBot account ID. */
export function resolveDefaultQQBotAccountId(cfg: TheClawConfig): string {
...
/** Apply account config updates back into the TheClaw config object. */
