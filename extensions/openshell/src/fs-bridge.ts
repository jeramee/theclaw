...
import { writeFileWithinRoot } from "theclaw/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "theclaw/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "theclaw/plugin-sdk/sandbox";
...
// import, and this helper is not yet part of the `theclaw/plugin-sdk/*`
