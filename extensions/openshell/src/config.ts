...
import { buildPluginConfigSchema, type TheClawPluginConfigSchema } from "theclaw/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): TheClawPluginConfigSchema {
