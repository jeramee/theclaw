...
export function applyArceeProviderConfig(cfg: TheClawConfig): TheClawConfig {
  return arceePresetAppliers.applyProviderConfig(cfg);
}

export function applyArceeConfig(cfg: TheClawConfig): TheClawConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

export function applyArceeOpenRouterConfig(cfg: TheClawConfig): TheClawConfig {
