...
type RegisteredLineCardCommand = Parameters<TheClawPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: TheClawPluginApi): Promise<RegisteredLineCardCommand> {
