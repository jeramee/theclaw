...
vi.mock("theclaw/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("theclaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("theclaw/plugin-sdk/command-auth", () => ({
...
vi.mock("theclaw/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("theclaw/plugin-sdk/group-access", () => ({
...
vi.mock("theclaw/plugin-sdk/routing", () => ({
