import type { ChannelSetupAdapter, TheClawConfig } from "theclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "theclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: TheClawConfig, accountId: string): boolean {
