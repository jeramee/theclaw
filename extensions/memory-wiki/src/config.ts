...
import { buildPluginConfigSchema, z, type TheClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: TheClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".theclaw", "wiki", "main");
}
