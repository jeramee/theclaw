...
const GENERATED_START = "<!-- theclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- theclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- theclaw:human:start -->";
const HUMAN_END = "<!-- theclaw:human:end -->";
