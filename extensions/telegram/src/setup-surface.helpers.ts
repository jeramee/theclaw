...
export function shouldShowTelegramDmAccessWarning(cfg: TheClawConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`theclaw config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`theclaw config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
