...
import { isAbortRequestText } from "theclaw/plugin-sdk/command-primitives-runtime";
import type {
  TheClawConfig,
  ReplyToMode,
...
async function resolveStickerVisionSupport(cfg: TheClawConfig, agentId: string) {
  try {
