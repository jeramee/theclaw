import { resolveNormalizedAccountEntry } from "theclaw/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "theclaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "theclaw/plugin-sdk/channel-plugin-common";
 ...
 *
 * See: https://github.com/theclaw/theclaw/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: TheClawConfig, accountId: string): boolean {
