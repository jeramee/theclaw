...
import type { ChannelMessageActionAdapter } from "theclaw/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "theclaw/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "theclaw/plugin-sdk/channel-pairing";
import { attachChannelToResult } from "theclaw/plugin-sdk/channel-send-result";
import {
...
} from "theclaw/plugin-sdk/outbound-send-deps";
import { type RoutePeer } from "theclaw/plugin-sdk/routing";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as TheClawConfig;
