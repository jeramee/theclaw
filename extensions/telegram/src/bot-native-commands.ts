...
import { resolveDefaultModelForAgent } from "theclaw/plugin-sdk/agent-runtime";
import { resolveChannelStreamingBlockEnabled } from "theclaw/plugin-sdk/channel-streaming";
import {
...
import type { ChannelGroupPolicy } from "theclaw/plugin-sdk/config-types";
import type {
  ReplyToMode,
...
import { getRuntimeConfigSnapshot } from "theclaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "theclaw/plugin-sdk/runtime-env";
...
type TelegramChunkMode = ReturnType<
  typeof import("theclaw/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("theclaw/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): TheClawConfig => telegramDeps.getRuntimeConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: TheClawConfig): TelegramAccountConfig => {
    try {
