...
const TELEGRAM_SENT_MESSAGES_STATE_KEY = Symbol.for("theclaw.telegramSentMessagesState");
...
function resolveSentMessageStorePath(cfg?: Pick<TheClawConfig, "session">): string {
...
function getSentMessageBucket(cfg?: Pick<TheClawConfig, "session">): SentMessageBucket {
...
function getSentMessages(cfg?: Pick<TheClawConfig, "session">): SentMessageStore {
...
export function recordSentMessage(
  ...
  messageId: number,
  cfg?: Pick<TheClawConfig, "session">,
): void {
