import { resolveAccountWithDefaultFallback } from "theclaw/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "theclaw/plugin-sdk/channel-core";
import type { TheClawConfig } from "theclaw/plugin-sdk/config-types";
import type { TelegramAccountConfig } from "theclaw/plugin-sdk/config-types";
import { resolveDefaultSecretProviderAlias } from "theclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "theclaw/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "theclaw/plugin-sdk/secret-input";
import { coerceSecretRef } from "theclaw/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: TheClawConfig; value: unknown }): {
  token: string;
