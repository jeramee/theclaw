...
function listConfiguredAccountIds(cfg: TheClawConfig): string[] {
...
function listBoundAccountIds(cfg: TheClawConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: TheClawConfig, channelId: string): string | null {
...
export function resolveDefaultTelegramAccountSelection(cfg: TheClawConfig): {
  accountId: string;
  accountIds: string[];
