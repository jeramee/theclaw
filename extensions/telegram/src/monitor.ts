...
import { resolveAgentMaxConcurrent } from "theclaw/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: TheClawConfig): RunOptions<unknown> {
  return {
    sink: {
