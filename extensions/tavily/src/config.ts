...
export function resolveTavilySearchConfig(cfg?: TheClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: TheClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: TheClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
