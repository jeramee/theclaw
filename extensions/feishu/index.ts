...
function registerFeishuDocTools(api: TheClawPluginApi) {
...
function registerFeishuChatTools(api: TheClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: TheClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: TheClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: TheClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: TheClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: TheClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: TheClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: TheClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: TheClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: TheClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
