...
function mergeSignalAccountConfig(cfg: TheClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: TheClawConfig): ResolvedSignalAccount[] {
