...
vi.mock("theclaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/hook-runtime")>(
    "theclaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
