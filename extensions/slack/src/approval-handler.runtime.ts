...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "theclaw/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalRequest } from "theclaw/plugin-sdk/approval-runtime";
import type { TheClawConfig } from "theclaw/plugin-sdk/config-types";
import { logError, normalizeOptionalString } from "theclaw/plugin-sdk/text-runtime";
import {
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<TheClawConfig["channels"]>["slack"]>["execApprovals"]
>;
