...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<TheClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<TheClawConfig["channels"]>["slack"]>>,
): TheClawConfig {
  return {
    channels: {
      slack: {
