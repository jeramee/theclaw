...
vi.mock("theclaw/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/channel-inbound")>(
    "theclaw/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
