...
import type { DmPolicy, GroupPolicy } from "theclaw/plugin-sdk/config-types";
import { createDedupeCache } from "theclaw/plugin-sdk/dedupe-runtime";
import { resolveDefaultAgentId } from "theclaw/plugin-sdk/agent-runtime";
import { formatErrorMessage } from "theclaw/plugin-sdk/error-runtime";
import type { HistoryEntry } from "theclaw/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("theclaw/plugin-sdk/config-types").SlackSlashCommandConfig>;
  textLimit: number;
