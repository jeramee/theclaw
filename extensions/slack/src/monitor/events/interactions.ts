...
// Prefix for TheClaw-generated action IDs to scope our handler
const THECLAW_ACTION_PREFIX = "theclaw:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${THECLAW_ACTION_PREFIX}`);

  // Handle TheClaw modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
