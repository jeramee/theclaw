import { formatInboundEnvelope } from "theclaw/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "theclaw/plugin-sdk/config-types";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("theclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
