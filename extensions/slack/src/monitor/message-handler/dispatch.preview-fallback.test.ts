...
vi.mock("theclaw/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("theclaw/plugin-sdk/channel-reply-pipeline", () => ({
...
vi.mock("theclaw/plugin-sdk/channel-streaming", () => ({
...
vi.mock("theclaw/plugin-sdk/outbound-runtime", () => ({
  resolveAgentOutboundIdentity: () => undefined,
}));

vi.mock("theclaw/plugin-sdk/reply-history", () => ({
  clearHistoryEntriesIfEnabled: () => {},
}));

vi.mock("theclaw/plugin-sdk/reply-payload", () => ({
...
vi.mock("theclaw/plugin-sdk/text-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/theclaw-store.json",
