...
vi.mock("theclaw/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("theclaw/plugin-sdk/fetch-runtime")>(
    "theclaw/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
