...
} from "theclaw/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "theclaw/plugin-sdk/channel-config-helpers";
import {
...
import { createLazyRuntimeModule } from "theclaw/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "theclaw/plugin-sdk/outbound-send-deps";
import { buildOutboundBaseSessionKey, type RoutePeer } from "theclaw/plugin-sdk/routing";
import {
...
//
// `theclaw/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "theclaw/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "theclaw/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as TheClawConfig, toolContext as SlackActionContext | undefined),
    }),
