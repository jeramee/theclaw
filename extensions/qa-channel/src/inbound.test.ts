import { createPluginRuntimeMock } from "theclaw/plugin-sdk/channel-test-helpers";
...
vi.mock("theclaw/plugin-sdk/inbound-reply-dispatch", () => ({
...
describe("handleQaInbound", () => {
  it("marks group messages that match configured mention patterns", async () => {
    ...
    vi.mocked(runtime.channel.mentions.buildMentionRegexes).mockReturnValue([/\b@?theclaw\b/i]);
