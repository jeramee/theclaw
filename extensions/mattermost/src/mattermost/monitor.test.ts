import { createClaimableDedupe } from "theclaw/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: TheClawConfig; threadRootId?: string }) {
