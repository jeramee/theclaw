import { createAccountListHelpers } from "theclaw/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "theclaw/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "theclaw/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: TheClawConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: TheClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: TheClawConfig): ResolvedMattermostAccount[] {
