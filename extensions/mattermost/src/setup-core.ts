...
import type { ChannelSetupAdapter } from "theclaw/plugin-sdk/channel-setup";
...
import { createSetupInputPresenceValidator } from "theclaw/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: TheClawConfig, accountId: string) {
