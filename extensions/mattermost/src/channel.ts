...
import { createLoggedPairingApprovalNotifier } from "theclaw/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "theclaw/plugin-sdk/channel-policy";
...
import { isPrivateNetworkOptInEnabled } from "theclaw/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "TheClaw: your access has been approved.",
