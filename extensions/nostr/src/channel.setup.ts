...
import { patchTopLevelChannelConfigSection } from "theclaw/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: TheClawConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: TheClawConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: TheClawConfig): string {
