...
import { resolveConfiguredCapabilityProvider } from "theclaw/plugin-sdk/provider-selection-runtime";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: TheClawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as TheClawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as TheClawConfig),
