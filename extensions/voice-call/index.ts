...
const voiceCallConfigSchema = {
  ...
  uiHints: {
    ...
    "realtime.toolPolicy": {
      ...
      help: "Controls the shared theclaw_agent_consult tool.",
      advanced: true,
    },
...
const VOICE_CALL_RUNTIME_KEY = Symbol.for("theclaw.voice-call.runtime");
const VOICE_CALL_RUNTIME_PROMISE_KEY = Symbol.for("theclaw.voice-call.runtimePromise");
const VOICE_CALL_RUNTIME_STOP_PROMISE_KEY = Symbol.for("theclaw.voice-call.runtimeStopPromise");
