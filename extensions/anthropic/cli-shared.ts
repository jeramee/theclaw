...
} from "theclaw/plugin-sdk/cli-backend";
...
// steer TheClaw-managed Claude CLI runs toward a different provider,
...
function isTheClawRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isTheClawRequestedYolo(context)
