...
export function resolveLegacyXSearchConfig(config?: TheClawConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: TheClawConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: TheClawConfig): JsonRecord | undefined {
