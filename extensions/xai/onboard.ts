...
>({
  ...
  resolveParams: (_cfg: TheClawConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: TheClawConfig): TheClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: TheClawConfig): TheClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: TheClawConfig): TheClawConfig {
