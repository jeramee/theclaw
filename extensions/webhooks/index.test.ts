...
function createApi(params?: {
  pluginConfig?: TheClawPluginApi["pluginConfig"];
  registerHttpRoute?: TheClawPluginApi["registerHttpRoute"];
  logger?: TheClawPluginApi["logger"];
}): TheClawPluginApi {
