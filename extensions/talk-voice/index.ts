...
import type { SpeechVoiceOption } from "theclaw/plugin-sdk/speech";
import { resolveActiveTalkProviderConfig } from "theclaw/plugin-sdk/talk-config-runtime";
import {
  ...
  register(api: TheClawPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as TheClawConfig;
