...
TheClaw is the AI that actually does things.
...
TheClaw started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> TheClaw.
...
Security in TheClaw is a deliberate tradeoff: strong defaults without killing capability.
...
TheClaw has an extensive plugin API.
...
- Code plugins run TheClaw plugin code and are appropriate for deeper runtime extension.
...
TheClaw docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
TheClaw supports MCP as both a server and a runtime integration surface.
...
TheClaw is currently terminal-first by design.
...
TheClaw is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep TheClaw hackable by default.
