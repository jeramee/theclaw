...
const WORKER_RUNTIME_STATE = Symbol.for("theclaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("theclaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("theclaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: TheClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
