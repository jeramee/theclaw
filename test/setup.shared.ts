...
declare global {
  ...
  var __THECLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__: ((...args: unknown[]) => unknown) | undefined;
}
...
vi.mock("@mariozechner/pi-ai/oauth", () => ({
  ...
  refreshOpenAICodexToken: vi.fn((...args: unknown[]) =>
    globalThis.__THECLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__?.(...args),
  ),
}));
...
// arbitrary THECLAW_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
process.env.THECLAW_TEST_TRUST_BUNDLED_PLUGINS_DIR ??= "1";
...
process.env.THECLAW_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
...
const SHARED_TEST_SETUP = Symbol.for("theclaw.sharedTestSetup");
