...
import { loadConfig, type TheClawConfig } from "../src/config/config.js";
import {
...
const REQUIRE_PROFILE_KEYS =
  isLiveProfileKeyModeEnabled() || isTruthyEnvValue(process.env.THECLAW_LIVE_REQUIRE_PROFILE_KEYS);
const describeLive = LIVE ? describe : describe.skip;
const providerFilter = parseCsvFilter(process.env.THECLAW_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.THECLAW_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.THECLAW_LIVE_IMAGE_GENERATION_MODELS);
...
function withPluginsEnabled(cfg: TheClawConfig): TheClawConfig {
  return {
    ...cfg,
    plugins: {
      ...cfg.plugins,
