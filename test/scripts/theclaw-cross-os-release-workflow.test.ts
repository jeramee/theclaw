...
const WORKFLOW_PATH = ".github/workflows/theclaw-cross-os-release-checks-reusable.yml";
const HARNESS = "bash workflow/scripts/github/run-theclaw-cross-os-release-checks.sh";
